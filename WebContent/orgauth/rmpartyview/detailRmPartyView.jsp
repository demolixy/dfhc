...
<input type="hidden" name="id" value="<%=RmStringHelper.prt(resultVo.getId())%>"></input>

<table align="center">
	<tr>
		<td><br/>
			<input type="button" class="button_ellipse" id="button_update" value="修改" onClick="javascript:find_onClick();"></input>
			<input type="button" class="button_ellipse" id="button_delete" value="删除" onClick="javascript:delete_onClick();"></input>
			<input type="button" class="button_ellipse" id="button_back" value="返回"  onClick="javascript:history.go(-1);" ></input>
		</td>
	</tr>
</table>
