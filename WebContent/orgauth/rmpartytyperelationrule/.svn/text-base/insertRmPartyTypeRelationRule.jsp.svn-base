...
<table class="mainTable">
	...
	<tr>
		...
		<td>
			<!-- <input type="text" class="text_field_reference" validate='notNull;' hiddenInputId="party_view_id" name="party_view_id_name" inputName="<%=IRmPartyTypeRelationRuleConstants.TABLE_COLUMN_CHINESE.get("party_view_id")%>" value="" /><input type="hidden" name="party_view_id"><img class="refButtonClass" src="<%=request.getContextPath()%>/images/09.gif" onClick="javascript:getNewReference('<%=request.getContextPath()%>/RmPartyViewAction.do?cmd=queryReference&referenceInputType=radio','form.party_view_id, form.party_view_id_name');"/> -->
			<input type="text" class="text_field"  name="party_view_id"/>
		</td>
		<td align="right"></td>
		<td></td>
	</tr>
	<tr>
		...
		<td>
			...
			<input type="text" class="text_field"  name="parent_party_type_id"/>
		</td>
		<td align="right"></td>
		<td></td>
	</tr>
	<tr>
		...
		<td>
			...
			<input type="text" class="text_field"  name="child_party_type_id"/>
		</td>
		<td align="right"></td>
		<td></td>
	</tr>
