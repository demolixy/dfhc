...
<!--				<iframe id="left_ifram_id" name="left_org_name" frameborder="0" width="200" height="500" src="<%=request.getContextPath()%>/orgauth/tree/org.jsp?cmd=<%=request.getParameter("cmd") != null ? request.getParameter("cmd") : sValue %>&view_id=<%=RmStringHelper.prt(view_id)%>&is_href=1&reference=1&enableCookie=true" scrolling="yes"></iframe>-->
			<iframe id="left_ifram_id" name="left_org_name" frameborder="0" width="200" height="500" src="<%=request.getContextPath()%>/pubController/getParty?cmd=<%=request.getParameter("cmd") != null ? request.getParameter("cmd") : sValue %>&view_id=<%=RmStringHelper.prt(view_id)%>&is_href=1&reference=1&enableCookie=true&source=orgBack" scrolling="yes"></iframe>
