...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr> 
     <td width="300" valign="top" align="left">&nbsp;&nbsp;&nbsp;&nbsp; 
		...
		<!--树开始-->  
			<iframe id="left_ifram_id" name="left_org_name" frameborder="0" width="200" height="500" src="<%=request.getContextPath()%>/orgauth/zTree/functionNodeZtree.jsp?cmd=roleData&is_href=1&reference=1&enableCookie=true&source=orgBack" scrolling="yes"></iframe>
...
<!--		<div name="deeptree" id="deeptree" class="deeptree"></div>-->
     ...
     <td width="*" valign="top" align="left">
     	<table>
     		<tr><td>
				<iframe frameborder="0" width="800" height="800" name="operation_frame" id="operation_frame" src="<%
