	...
	<tr>
		...
		<td align="left">
			<div id="owner_id" align="left">
				<input type="text" class="text_field_readonly"  value="<%=RmStringHelper.prt(parent_party_name) %>" hiddenInputId="owner_org_id" name="owner_org_id_name" inputName="<%=IRmRoleConstants.TABLE_COLUMN_CHINESE.get("owner_org_id")%>" value="" />
				<input type="hidden" value="<%=RmStringHelper.prt(parent_party_id) %>" name="owner_org_id"></input>
				<img class="refButtonClass" src="<%=request.getContextPath()%>/images/09.gif" onClick="getParty('<%=request.getContextPath()%>/pubController/getParty','owner_org_id,owner_org_id_name','form')"/>        
        	</div>
        </td>
	</tr>
	<tr>
