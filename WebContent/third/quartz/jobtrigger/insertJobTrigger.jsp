...
<table class="mainTable">
	...
	<tr>
		...
		<td>
			<input type="text" class="text_field_half" name="job_name" inputName="<%=IJobTriggerConstants.TABLE_COLUMN_CHINESE.get("job_name")%>" value="" maxLength="100" validate="notNull;"/><input type="text" class="text_field_half" name="job_group" /><img class="refButtonClass" src="<%=request.getContextPath()%>/images/09.gif" onClick="javascript:getReferenceOld(new Array(form.job_name, form.job_group), '<%=request.getContextPath()%>/', '<%=request.getContextPath()%>/JobDetailAction.do?cmd=queryReference&referenceInputType=radio');"/>
		</td>
		<td align="right"></td>
		<td></td>
	</tr>
