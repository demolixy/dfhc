...
<div class="zc_nav">
	<c:choose>
		...
		<c:when test="${operator == '3' }">
			 <a href="javascript:void(0);" class="flex1" operation="10">充装前检查</a>
		     <a href="javascript:void(0);" class="flex1" operation="11">充装中检查</a>
		      <a href="javascript:void(0);" class="flex1" operation="12">充装后检查</a>
		     <a href="javascript:void(0);" class="flex1" operation="13">检查结果</a>
		</c:when>
	</c:choose>
