                   ...
                   <!-- begin table 头 -->
                     <div class="portlet-title">
                        ...
                        <div class="actions">
                          ...
                          <a href="javascript:void(0);" class="shi-btn "onclick="javascript:add_line('role_list')" >  +增加表达式</a>
                        </div>
                       ...
                       <table class="shi-table" id="role_list">
                         ...
                         <tbody >
                           ...
                           <tr  ng-repeat="candidateGroup in assignment.candidateGroups">
								...
								<td>
								    <input id="userField" class="form-control" type="text" readonly="readonly" ng-model="candidateGroup.value" />
								</td>
								
								<td>
								   <a href="javascript:void(0)"  ng-click="removeCandidateGroupValue($index)">删除</a>
								</td>
...
<!--begin编辑 输入框弹出层 -->
  ...
  <div class="content-div">
	  ...
	  <div class="frame_div" id="frame_div">
	   ...
	   <iframe  name="assignee_frame" id="assignee_frame"></iframe>
...
function addUserHtml(obj){
	 ...
	 var operateUsers=_scope.assignment.candidateUsers;//默认存放候选人
	 if(showDivId!='usertab'){//代理人、候选用户
	   operateUsers=_scope.assignment.candidateGroups;//不是候选人默认时组
	 }
...
function cascadeAdd(dateId){
	...
	if(showDivId=='usertab'){//代理人、候选用户
	    ...
	    var flowgroups= _scope.assignment.candidateGroups;//候选组
		flowgroups.splice(flowgroups.length+1, 0, {'value':dateId });
