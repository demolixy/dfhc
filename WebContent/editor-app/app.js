...
//	                    alert(propSectionHeight);
//	                   20161205 canvas.height(totalAvailable - propSectionHeight);
	                    canvas.height(totalAvailable);
	                    jQuery('#paletteSection').height(totalAvailable);
	                    jQuery('#propertySection').css('height',totalAvailable);
//	                    alert(jQuery('#propertySection').height());
