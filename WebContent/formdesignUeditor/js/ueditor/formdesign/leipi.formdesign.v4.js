...
UE.plugins['selectprocess'] = function () {
	var me = this,thePlugins = 'selectprocess';
	me.commands[thePlugins] = {
			execCommand:function () {
				var dialog = new UE.ui.Dialog({
					iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/selectprocess.jsp',
					name:thePlugins,
					editor:this,
					title: '选择流程',
					cssRules:"width:600px;height:310px;",
	...
	me.addListener( 'mouseover', function( t, evt ) {
		...
		if ( /input/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
			var html = popup.formatHtml(
				'<nobr>表单: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
			if ( html ) {
				popup.getDom( 'content' ).innerHTML = html;
				popup.anchorEl = el;
				popup.showAnchor( popup.anchorEl );
...
UE.plugins['selectbusinessgroup'] = function () {
	var me = this,thePlugins = 'selectbusinessgroup';
	me.commands[thePlugins] = {
			execCommand:function () {
				var dialog = new UE.ui.Dialog({
					iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/selectbusinessgroup.jsp',
					name:thePlugins,
					editor:this,
					title: '选择流程',
					cssRules:"width:600px;height:310px;",
...
UE.plugins['button'] = function () {
	...
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/button.jsp',
				name:thePlugins,
				editor:this,
				title: '按钮',
				cssRules:"width:600px;height:310px;",
...
UE.registerUI('button_text',function(editor,uiName){
    ...
    var btn = new UE.ui.Button({
        ...
        title:"文本框",
        //需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
        cssRules :'background-position: -498px -20px;',
        //点击时执行的命令
        onclick:function () {
            //这里可以不用执行命令,做你自己的操作也可
           editor.execCommand(uiName);
...
UE.registerUI('button_textarea',function(editor,uiName){
	...
	var btn = new UE.ui.Button({
		...
		title:"多行文本框",
		//需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
		cssRules :'background-position: -601px -20px;',
		//点击时执行的命令
		onclick:function () {
			//这里可以不用执行命令,做你自己的操作也可
			editor.execCommand(uiName);
...
UE.registerUI('button_select',function(editor,uiName){
	...
	var btn = new UE.ui.Button({
		...
		title:"下拉菜单",
		//需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
		cssRules :'background-position: -320px 0px;',
		//点击时执行的命令
		onclick:function () {
			//这里可以不用执行命令,做你自己的操作也可
			editor.execCommand(uiName);
...
//单选框
UE.registerUI('button_radio',function(editor,uiName){
	if(!this.options.toolleipi)
	{
		return false;
	}
	...
	var btn = new UE.ui.Button({
		...
		title:"单选框",
		//需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
		cssRules :'background-position: -339px -20px;',
		//点击时执行的命令
		onclick:function () {
			//这里可以不用执行命令,做你自己的操作也可
			editor.execCommand(uiName);
...
UE.registerUI('button_radios',function(editor,uiName){
	...
	var btn = new UE.ui.Button({
		...
		title:"单选框组",
		//需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
		cssRules :'background-position: -462px -20px;',
		//点击时执行的命令
		onclick:function () {
			//这里可以不用执行命令,做你自己的操作也可
			editor.execCommand(uiName);
...
UE.registerUI('button_checkboxs',function(editor,uiName){
	...
	var btn = new UE.ui.Button({
		...
		title:"复选框组",
		//需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
		cssRules :'background-position: -784px -40px;',
		//点击时执行的命令
		onclick:function () {
			//这里可以不用执行命令,做你自己的操作也可
			editor.execCommand(uiName);
...
//复选框
UE.registerUI('button_checkbox',function(editor,uiName){
	if(!this.options.toolleipi)
	{
		return false;
	}
	...
	var btn = new UE.ui.Button({
		...
		title:"复选框",
		//需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
		cssRules :'background-position: -780px -20px;',
		//点击时执行的命令
		onclick:function () {
			//这里可以不用执行命令,做你自己的操作也可
			editor.execCommand(uiName);
...
*/
UE.registerUI('button_convert',function(editor,uiName){
    if(!this.options.toolleipi)
    {
        return false;
    }
    ...
    editor.registerCommand(uiName,{
        execCommand:function(){
            try {
                leipiFormDesign.fnCheckForm('convert');
            } catch ( e ) {
                alert(e);
            }
    ...
    var btn = new UE.ui.Button({
        ...
        title:"转换模板",
        //需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
        cssRules :'background-position: -183px -20px;',
        //点击时执行的命令
        onclick:function () {
            //这里可以不用执行命令,做你自己的操作也可
           editor.execCommand(uiName);
...
UE.registerUI('button_form',function(editor,uiName){
    if(!this.options.toolleipi)
    {
        return false;
    }
    ...
    editor.registerCommand(uiName,{
        execCommand:function(){
            try {
                //leipiFormDesign.fnCheckForm('form');
            	leipiFormDesign.exec('form');
            } catch ( e ) {
                alert(e);
            }
    ...
    var btn = new UE.ui.Button({
        ...
        title:"添加form",
        //需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
        cssRules :'background-position: -183px -39px;',
        //点击时执行的命令
        onclick:function () {
            //这里可以不用执行命令,做你自己的操作也可
           editor.execCommand(uiName);
...
UE.registerUI('button_button',function(editor,uiName){
    if(!this.options.toolleipi)
    {
        return false;
    }
    ...
    var btn = new UE.ui.Button({
        ...
        title:"添加按钮",
        //需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
        cssRules :'background-position: -80px -20px;',
        //点击时执行的命令
        onclick:function () {
            //这里可以不用执行命令,做你自己的操作也可
           editor.execCommand(uiName);
...
UE.registerUI('button_selectbusinessgroup',function(editor,uiName){
    if(!this.options.toolleipi)
    {
        return false;
    }
    ...
    editor.registerCommand(uiName,{
        execCommand:function(){
            try {
                //leipiFormDesign.fnCheckForm('form');
            	leipiFormDesign.exec('selectbusinessgroup');
            } catch ( e ) {
                alert(e);
            }
    ...
    var btn = new UE.ui.Button({
        ...
        title:"选择业务组",
        //需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
        cssRules :'background-position: 0px -20px;',
        //点击时执行的命令
        onclick:function () {
            //这里可以不用执行命令,做你自己的操作也可
           editor.execCommand(uiName);
...
UE.registerUI('button_uploadfile',function(editor,uiName){
    if(!this.options.toolleipi)
    {
        return false;
    }
    ...
    editor.registerCommand(uiName,{
        execCommand:function(){
            try {
                //leipiFormDesign.fnCheckForm('form');
            	leipiFormDesign.exec('uploadfile');
            } catch ( e ) {
                alert(e);
            }
    ...
    var btn = new UE.ui.Button({
        ...
        title:"上传",
        //需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
        cssRules :'background-position: 0px -40px;',
        //点击时执行的命令
        onclick:function () {
            //这里可以不用执行命令,做你自己的操作也可
           editor.execCommand(uiName);
...
UE.registerUI('button_selectprocess',function(editor,uiName){
	if(!this.options.toolleipi)
	{
		return false;
	}
	...
	editor.registerCommand(uiName,{
		execCommand:function(){
			try {
				//leipiFormDesign.fnCheckForm('form');
				leipiFormDesign.exec('selectprocess');
			} catch ( e ) {
				alert(e);
			}
	...
	var btn = new UE.ui.Button({
		...
		title:"选择流程",
		//需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
		cssRules :'background-position: -750px -75px;',
		//点击时执行的命令
		onclick:function () {
			//这里可以不用执行命令,做你自己的操作也可
			editor.execCommand(uiName);
