...
<script type="text/javascript">
   ...
   $(function(){
         ...
         var url="<%=request.getContextPath()%>/user/assigneeUser";
        sorting(url);
   });

    function simpleQuery_onClick(){  //简单的模糊查询
        form.action="<%=request.getContextPath()%>/user/assigneeUser";
        form.submit();
    }
...
<body class="page-header-fixed">
  <div  style="margin: 0px 0px 0px 0px;padding: 0px 0px;">
  <!-- begain查询 -->
						...
						<div class="portlet-body no-more-tables dataTables_wrapper form-inline" style="overflow: auto;" >
							<table class="table table-striped table-bordered table-hover table-full-width dataTable" aria-describedby="sample_2_info">
								...
								<td>
									<div class="checkbox" >
										<ins id="ischeck">
											<input type="hidden" name="checkbox_template"  displayName="${list.name}" class="checkmain" ischecked="false" checkedId="<c:out value="${list.id}"></c:out>" />
										</ins>
									</div>
								</td>
