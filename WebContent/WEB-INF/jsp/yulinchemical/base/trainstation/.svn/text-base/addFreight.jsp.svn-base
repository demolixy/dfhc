           ...
           <div class="control-group">
				...
				<%--  		<div class="input-prepend">
						 ...
						 --%>		
							  ...
							  <input class="m-wrap" name="yuanTon" id="yuanTon" type="hidden"  			style="    width: 180px;"	readOnly		maxLength="19" />
		                     ...
		                     <div class="widget-body">
		                       ...
		                       <div class="widget-main">
		                         ...
		                         <table  class="table table-striped table-bordered table-hover detail-tab">
			                       ...
			                       <tr>     
			                             <th><%=ITrainStationConstants.TABLE_COLUMN_DISPLAY.get("stationName")%>:</th>
			                             <td colspan="2"><c:out value="${bean.stationName }"></c:out> </td>
			                       
			                          	 <th><%=ITrainStationConstants.TABLE_COLUMN_DISPLAY.get("remark")%>:</th>
			                             <td colspan="2"> <c:out value="${bean.remark }"></c:out>  </td>
			                         </tr>
...
/* 					//查询
					 ...
					 function addShow(){
						    ...
						    var  targetType='<%=ISystemConstant.DICTIONARY_TARGET_TYPE_02%>';	
