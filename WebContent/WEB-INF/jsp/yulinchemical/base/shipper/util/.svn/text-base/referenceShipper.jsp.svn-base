   ...
   <form name="form" id="form" class="FormGrid ui_inner_form" method="post" >
           ...
           <div class="control-group">
							...
							<div class="input-prepend">
							  <span class="add-on"><%=IShipperConstants.TABLE_COLUMN_DISPLAY.get("name")%></span><input class="m-wrap" name="name" id="name" type="text"  						maxLength="300" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=IShipperConstants.TABLE_COLUMN_DISPLAY.get("code")%></span><input class="m-wrap" name="code" id="code" type="text"  						maxLength="10" />
							</div>
     ...
     <div class="EditTable operate_div" >
       <a href="javascript:void(0)" id="sData" class="fm-button ui-state-default ui-corner-all fm-button-icon-left" onclick="javascript:searchShi('<%=request.getContextPath()%>/shipper/reference?referenceInputType=${referenceInputType}');">
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: getRootPath()+'/shipper/referenceAjax',
					datatype: "json",
				    mtype: 'POST',  
					height: 250,
					colNames:['code','name',
...
,'<%=IShipperConstants.TABLE_COLUMN_DISPLAY.get("isDefault")%>'
					...
					colModel:[
					    {name:'code',index:'code',width:90, editable:true,hidedlg:true,hidden:true},		
