...
// 	var rowData = $("#grid-table").jqGrid('getRowData',selectedId);
	...
	var url='${pageContext.request.contextPath}/receiptaddress/ajaxDeleteReceiptaddress';
	$.ajax({
	    type:'post',//可选get
	    url:url,
...
aria-labelledby="edithdgrid-table" aria-hidden="false" >
  <div class="ui-jqdialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix"  style="cursor: move;">
   ...
   <form name="updateForm" id="updateForm" class="FormGrid ui_inner_form" >
     ...
     <div class="EditTable operate_div" >
       <a href="javascript:void(0)" id="sData" class="fm-button ui-state-default ui-corner-all fm-button-icon-left" onclick="javascript:updateSave()">
       <i class="icon-ok"></i>
            更新</a>
       <a href="javascript:void(0)" id="cData" class="cancel fm-button ui-state-default ui-corner-all fm-button-icon-left">
      <i class="icon-remove"></i> 
		                       ...
		                       <div class="widget-main">
		                         ...
		                         <table  class="table table-striped table-bordered table-hover detail-tab">
			                       ...
			                       <th>客户名称:</th>
			                      	 ...
			                      	 <th><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("abbreviation")%>:</th>
			                             <td colspan="2">
			                                 <c:out value="${bean.abbreviation }"></c:out>
			                              </td>
			                          </tr>
			                           <tr>
			                       <th><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("indexCode")%>:</th>
			                             <td colspan="2">
			                                 <c:out value="${bean.indexCode}"></c:out>
			                              </td>
			                       
			                      	 <th><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("regAddr")%>:</th>
			                             <td colspan="2">
			                                 <c:out value="${bean.regAddr}"></c:out>
			                              </td>
			                          </tr>
			                           <tr>
			                       <th><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("officeAddr")%>:</th>
			                             <td colspan="2">
			                                 <c:out value="${bean.officeAddr}"></c:out>
			                              </td>
			                       
			                      	 <th><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("postAddr")%>:</th>
			                             <td colspan="2">
			                                 <c:out value="${bean.postAddr}"></c:out>
			                              </td>
			                          </tr> 
			                          <tr>
			                       		<th><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("postCode")%>:</th>
			                             <td colspan="2">
			                                 <c:out value="${bean.postCode}"></c:out>
			                              </td>
			                       
			                      	 	<th><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("fax")%>:</th>
			                             <td colspan="2">
			                                 <c:out value="${bean.fax}"></c:out>
			                              </td>
			                          </tr>
			                          <tr>
			                       		<th><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("tel")%>:</th>
			                             <td colspan="2">
			                                 <c:out value="${bean.tel}"></c:out>
			                              </td>
			                       
			                      	 	<th><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("contacts")%>:</th>
			                             <td colspan="2">
			                                 <c:out value="${bean.contacts}"></c:out>
			                              </td>
			                          </tr>
			                          
			                          <tr>
			                       		<th><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("contactPhone")%>:</th>
			                             <td colspan="2">
			                                 <c:out value="${bean.contactPhone}"></c:out>
			                              </td>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: getRootPath()+'/receiptaddress/ajaxList?userId=${bean.userId}',
					datatype: "json",
				    mtype: 'POST',  
					height: "100%",
					colNames:[
...
/* 					//查询
					 ...
					 function addShow(){
					    ...
					    $("#add_form").find("input[name=userId]").val(userId);
				     ...
				     function updateShow(){
	                    ...
	                    $.ajax({
	                        ...
	                        success: function(data,status) {
	                            ...
	                            $("#portlet-config-edit").find("input[name=isDefault]").val(data.bean.isDefault);
	                	     }
	                       },
	                       error:function(xhr,s1,s2){
	                       	var message = xhr.responseText;
