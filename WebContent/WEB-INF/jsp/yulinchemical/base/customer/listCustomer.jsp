...
<%@page import="com.dfhc.base.customer.ICustomerConstants" %>
...
function _saveInsert(){	
	...
	var name= $("#add_form").find("input[name=abbreviation]").val();
	if(name.length>0){
		var regu =/^[A-Za-z0-9]*$/;
	    if (regu.test(name)) {
	    	alert("请输入正确的用户简称!");
	...
	if(name.length>0){
	    ...
	    var name= $("#add_form").find("input[name=userName]").val();
		if(name.length>0){
	...
	submitInsertAjax('<%=request.getContextPath()%>/customer/insert',$(insertForm).serialize());
...
function _saveUpdate(){	
	...
	var psw=$("#updateForm").find("input[name='password']").val();
	psw=$.trim(psw);
	$("#updateForm").find("input[name='password']").val(psw);
	
	pwdMd5(psw,'updateForm');
	
	if(!flag){
		return flag;
	}	
	
	var name= $("#updateForm").find("input[name=abbreviation]").val();
	if(name.length>0){
		var regu = /^[0-9]\d*[\.]?[0-9]{0,4}$/;
	    if (regu.test(name)) {
	    	alert("请输入正确的用户简称!");
	...
	submitInsertAjax('<%=request.getContextPath()%>/customer/update?operation=${operation}',$(updateForm).serialize());
   ...
   <div class="control-group">
			 <div class="controls">
							...
							<div class="input-prepend">
							  ...
							  <input class="m-wrap notNullInp" name="name"  type="text"  maxLength="100" /> 
							   <i class="notNull">*</i>
							</div>
								
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("abbreviation")%></span>
							  <input class="m-wrap notNullInp" name="abbreviation"  type="text"  maxLength="200" /> 
							   <i class="notNull">*</i>
							</div>
							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("indexCode")%></span><input class="m-wrap" name="indexCode"  type="text"  						maxLength="200" />
							</div>

							<div class="input-prepend" >
							  <span class="add-on">登陆名</span>	
							    <input type="text" class="m-wrap notNullInp"  name="userName"   />	
							    <i class="notNull">*</i>	
                        	</div>
                        	
                           <div class="input-prepend">
							  <span class="add-on">邮箱</span><input class="m-wrap notNullInp" name="email"  type="text"  maxLength="50" />
							  <i class="notNull">*</i>
							</div>
							
	                         <div class="input-prepend">
							  <span class="add-on">账户密码</span><input class="m-wrap notNullInp" name="password"  type="password"  maxLength="50" />
							  <i class="notNull">*</i>
							</div>
							...
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("regAddr")%></span><input class="m-wrap" name="regAddr"  type="text"  						maxLength="200" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("officeAddr")%></span><input class="m-wrap" name="officeAddr"  type="text"  						maxLength="200" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("postAddr")%></span><input class="m-wrap" name="postAddr"  type="text"  						maxLength="200" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("postCode")%></span>
							...
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("fax")%></span><input class="m-wrap" name="fax"  type="text"  						maxLength="50" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("tel")%></span>
							...
							<span class="add-on">省</span>
								<select name="provinceId" style="min-width: 207px;" >
									<option></option>
								</select>
...
<%=RmJspHelper.getSelectField("regionId",-1, RmProjectHelper.getCommonServiceInstance().paseToArrays("select id as data_key,name as data_value from BASE_REGION where nvl(BASE_REGION.DELETE_FLAG,'0') = 0"),"", "    inputName=\""+ICustomerConstants.TABLE_COLUMN_DISPLAY.get("regionId")+"\" validate='notNull;'  ", true , "--请选择--") %>										
							</div>
				
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("bank")%></span>
							  <input class="m-wrap" name="bank"  type="text"  						maxLength="50" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("accountName")%></span><input class="m-wrap" name="accountName"  type="text"  						maxLength="50" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("taxNo")%></span><input class="m-wrap" name="taxNo"  type="text"  						maxLength="50" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("legalPerson")%></span><input class="m-wrap" name="legalPerson"  type="text"  						maxLength="50" />
							</div>


							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("contacts")%></span><input class="m-wrap" name="contacts"  type="text"  						maxLength="200" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("contactPhone")%></span><input class="m-wrap" name="contactPhone"  type="text"  						maxLength="20" />
							</div>
							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("mainCode")%></span><input class="m-wrap" name="mainCode"  type="text"  						maxLength="200" />
							</div>
								
							<div class="input-prepend"  >
							  <span class="add-on "><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("isByProduct")%></span><%=RmJspHelper.getSelectField("isByProduct", -1, RmGlobalReference.get(ISystemConstant.DICTIONARY_RM_YES_NOT), "", "inputName='" + ICustomerConstants.TABLE_COLUMN_DISPLAY.get("isByProduct") + "'  ", true) %>							
						    </div>
							   
							<div class="input-prepend" >
							  <span class="add-on "><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("isMainProduct")%></span><%=RmJspHelper.getSelectField("isMainProduct", -1, RmGlobalReference.get(ISystemConstant.DICTIONARY_RM_YES_NOT), "", "inputName='" + ICustomerConstants.TABLE_COLUMN_DISPLAY.get("isMainProduct") + "'  ", true) %>							
							  
							  </div>
							<div class="input-prepend" >
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("remark")%></span>           	                       
							  <textarea cols="3" rows="5" class="medium m-wrap" name="remark" id="remark" inputName="<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("remark")%>" 	 maxLength="1000"  ></textarea>
							</div>
     ...
     <input type="hidden" name="party_type_id"  value="<%=IOrgauthConstants.Config.isUserRelationParty.value() && RmPartyTypeCache.getPartyType(IRmUserConstants.TABLE_NAME) != null ? RmPartyTypeCache.getPartyType(IRmUserConstants.TABLE_NAME).getId() : ""%>"/>
           ...
           <div class="control-group">
						...
						<input id="id" name="id" type="hidden" /> 
							...
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("abbreviation")%></span>
							  <input class="m-wrap" name="abbreviation" id="abbreviation" type="text"  						maxLength="200" />
							</div>
							
							<div class="input-prepend">
							  <span class="add-on">登陆名</span>	
							    <input type="text" class="m-wrap "   id="userName" name="userName" readOnly=true />	
                        	</div>
	                         ...
	                         <div class="input-prepend">
							  ...
							  <input class="m-wrap notNullI" name="password"  type="password"  maxLength="50" />
							  <i class="notNull">*</i>
							</div>
							...
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("indexCode")%></span><input class="m-wrap" name="indexCode" id="indexCode" type="text"  						maxLength="200" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("regAddr")%></span><input class="m-wrap" name="regAddr" id="regAddr" type="text"  						maxLength="200" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("officeAddr")%></span><input class="m-wrap" name="officeAddr" id="officeAddr" type="text"  						maxLength="200" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("postAddr")%></span><input class="m-wrap" name="postAddr" id="postAddr" type="text"  						maxLength="200" />
							</div>
							...
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("fax")%></span><input class="m-wrap" name="fax" id="fax" type="text"  						maxLength="50" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("tel")%></span>
							  <input class="m-wrap " name="tel" id="tel" type="text"  						maxLength="50" />
							...
							<div class="input-prepend" style="margin-top:-11px;">
							<span class="add-on">省</span>
								<select name="provinceId" style="min-width: 208px;" >
									<option></option>
								</select>
									<input class="m-wrap " name="provinceIdName" value="" type="hidden"/>
...
<%=RmJspHelper.getSelectField("regionId",-1, RmProjectHelper.getCommonServiceInstance().paseToArrays("select id as data_key,name as data_value from BASE_REGION where nvl(BASE_REGION.DELETE_FLAG,'0') = 0"),"", "    inputName=\""+ICustomerConstants.TABLE_COLUMN_DISPLAY.get("regionId")+"\" validate='notNull;'  ", true, "--请选择--")%>										
							...
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("bank")%></span><input class="m-wrap" name="bank" id="bank" type="text"  						maxLength="50" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("accountName")%></span><input class="m-wrap" name="accountName" id="accountName" type="text"  						maxLength="50" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("taxNo")%></span><input class="m-wrap" name="taxNo" id="taxNo" type="text"  						maxLength="50" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("legalPerson")%></span><input class="m-wrap" name="legalPerson" id="legalPerson" type="text"  						maxLength="50" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("contacts")%></span><input class="m-wrap" name="contacts" id="contacts" type="text"  						maxLength="200" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("contactPhone")%></span><input class="m-wrap" name="contactPhone" id="contactPhone" type="text"  						maxLength="20" />
							</div>
							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("mainCode")%></span><input class="m-wrap" name="mainCode" id="mainCode" type="text"  						maxLength="200" />
							</div>
   ...
   <form name="form" id="form" class="FormGrid ui_inner_form" method="post" >
           ...
           <div class="control-group">
							...
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("abbreviation")%></span><input class="m-wrap" name="abbreviation"  type="text"  						maxLength="200" />
							</div>

				<%--		<div class="input-prepend">
							  <span class="add-on"><%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("tel")%></span><input class="m-wrap" name="tel"  type="text"  						maxLength="50" />
							</div>
   ...
   <form name="deleteForm" id="deleteForm" class="FormGrid ui_inner_form"  method="post"  >
     ...
     <div class="EditTable operate_div" >
       <a href="javascript:void(0)" id="sData" class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn-danger" onclick="javascript:_delete('<%=request.getContextPath()%>/customer/logicDelete?pcode=${pcode }');">
						...
						<ul class="breadcrumb">
							...
							<c:choose>
								<c:when test="${operation == 'coordination' }">
									...
									<li class="active">客户信息变更</li>
								</c:when>
								<c:otherwise>
									<li>
										<a href="#">基础信息</a>
									</li>
									<li class="active">客户管理维护</li>
								</c:otherwise>
							</c:choose>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: getRootPath()+'/customer/ajaxList?operation=${operation}',
					datatype: "json",
				    mtype: 'POST',  
					height: "100%",
					colNames:[
					          '客户名称',
'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("userId")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("abbreviation")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("indexCode")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("regAddr")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("officeAddr")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("postAddr")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("postCode")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("fax")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("tel")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("provinceId")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("provinceIdName")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("cityId")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("cityName")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("bank")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("accountName")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("taxNo")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("legalPerson")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("remark")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("status")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("regionId")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("contacts")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("contactPhone")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("mainCode")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("isByProduct")%>'
,'<%=ICustomerConstants.TABLE_COLUMN_DISPLAY.get("isMainProduct")%>'
],
					colModel:[
			...
			{name:'abbreviation',index:'abbreviation', width:90,editable: true,editoptions:{size:"20",maxLength:"200"}},
			...
			{name:'remark',index:'remark', width:90,editable: true,editoptions:{size:"20",maxLength:"1000"}},
			{name:'status',index:'status', width:90,editable: true,hidedlg:true,hidden:true,editoptions:{size:"20",maxLength:"1"}},
			{name:'regionId',index:'regionId', width:90,editable: true,hidedlg:true,hidden:true,editoptions:{size:"20",maxLength:"19"}},
			...
			{name:'mainCode',index:'mainCode', width:90,editable: true,hidedlg:true,hidden:true,editoptions:{size:"20",maxLength:"200"}},
			{name:'isByProduct',index:'isByProduct', width:90,editable: true,hidedlg:true,hidden:true,editoptions:{size:"20",maxLength:"1"},formatter:orderStatus},
			{name:'isMainProduct',index:'isMainProduct', width:90,editable: true,hidedlg:true,hidden:true,editoptions:{size:"20",maxLength:"1"},formatter:orderStatus}
					], 
					...
					editurl: getRootPath()+'/customer/update',//nothing is saved
					caption: "客户管理列表展示",
					autowidth: true
				...
				<c:choose>
					...
					//收货方页面
	 				  jQuery(grid_selector).navButtonAdd(pager_selector,
	 					{ caption:"",title:"收货地址维护", buttonicon:"icon-group red",
	 					  onClickButton:toAddReceiptAddress , 
	 				      position:"last" }) ;
					
				//去收货地址维护页面
				     function toAddReceiptAddress(){
				    	 ...
				    	 window.location.href="${pageContext.request.contextPath}/customer/toAddReceiptAddress/"+id.toString();
			     ...
			     function updateShow(){
			    	 ...
			    	 var checkedVal=$("#grid-table").jqGrid("getGridParam", "selarrrow");
                    ...
                    var updateDate=checkedVal[0];
                    $.ajax({
                        type: "POST",
                        url: "<%=request.getContextPath()%>/customer/get/" + updateDate+"/"+new Date(),
                      ...
                      $("#portlet-config-edit").find("input[id=abbreviation]").val(data.bean.abbreviation);
                      ...
                      $("#portlet-config-edit").find("input[name=mainCode]").val(data.bean.mainCode);
                      $("#portlet-config-edit").find("input[id=isByProduct]").val(data.bean.is_by_product);
                      $("#portlet-config-edit").find("input[id=isMainProduct]").val(data.bean.is_by_product);
                      ...
                      $("#portlet-config-edit").find("input[id=regionId]").val(data.bean.regionId);
                      ...
                      $("#portlet-config-edit").find("input[id=userName]").val(data.bean.userName);
                      $(".ui_out_tan").show();
