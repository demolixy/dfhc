...
function updateSave(){
	...
	var a = $("#updateForm").find("input[name=yuanKmTon]").val();
	var b = $("#updateForm").find("input[name=mileage]").val();
	var c = $("#updateForm").find("input[name=yuanTon]").val();
	 c=a*b;
	  $("#updateForm").find("input[name=yuanTon]").val(c);
			 ...
			 <div class="controls">
						...
						<i class="notNull">*</i>
							...
							--%>	
							 ...
							 <input class="m-wrap " name="yuanTon" readOnly  type="hidden"  						maxLength="19" />
		                         ...
		                         <table  class="table table-striped table-bordered table-hover detail-tab">
			                       ...
			                       <tr>
			                      	 ...
			                      	 <th>客户名称:</th>
			                             ...
			                             <th><%=IReceiptAddressConstants.TABLE_COLUMN_DISPLAY.get("province")%>:</th>
			                             <td colspan="2">   
			                              <c:out value="${bean.province }"></c:out>
			                              </td>
			                            
			                          </tr>
			                       <tr>     
			                             <th><%=IReceiptAddressConstants.TABLE_COLUMN_DISPLAY.get("city")%>:</th>
			                             <td colspan="2"><c:out value="${bean.city }"></c:out> </td>
			                       
			                          	 <th><%=IReceiptAddressConstants.TABLE_COLUMN_DISPLAY.get("districtCounty")%>:</th>
			                             <td colspan="2"> <c:out value="${bean.districtCounty }"></c:out>  </td>
			                         </tr>
			                       <tr>     
			                             <th><%=IReceiptAddressConstants.TABLE_COLUMN_DISPLAY.get("address")%>:</th>
			                             <td colspan="2">  <c:out value="${bean.address }"></c:out>  </td>
			                          
			                             <th><%=IReceiptAddressConstants.TABLE_COLUMN_DISPLAY.get("recipient")%>:</th>
			                             <td colspan="2">  <c:out value="${bean.recipient }"></c:out>  </td>
			                       </tr>
			                       <tr>   
			                             <th><%=IReceiptAddressConstants.TABLE_COLUMN_DISPLAY.get("recipientPhone")%>:</th>
			                             <td colspan="2">  <c:out value="${bean.recipientPhone }"></c:out> </td>
			                          
			                             <th><%=IReceiptAddressConstants.TABLE_COLUMN_DISPLAY.get("zipcode")%>:</th>
			                             <td colspan="1">   <c:out value="${bean.zipcode }"></c:out> </td>
...
/* 					//查询
					 ...
					 function addShow(){
						    ...
						    var  targetType='<%=ISystemConstant.DICTIONARY_TARGET_TYPE_00%>';	
