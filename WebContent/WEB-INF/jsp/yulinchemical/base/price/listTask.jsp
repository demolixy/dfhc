		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: getRootPath()+'/price/ajaxListTask?${queryString}',
					datatype: "json",
				    mtype: 'POST',  
					height: "100%",
					colNames:[
...
,'操作'
			...
			{name:'doubleParameter',index:'doubleParameter',width:90, editable:true, sorttype:"date",formatter:splicedUrlTask},
				...
				function splicedUrlTask(cellvalue, options, cell){
					...
					if(arr[1]=='' || arr[1]=='null'){
						var url = '<a href="${pageContext.request.contextPath}/generalbusinessprocess/claim/'+arr[0]+'" >签收</a>';
					}else{
						var url = '<a href="${pageContext.request.contextPath}/generalbusinessprocess/view/'+arr[0]+'" >办理</a>';
					}
					return url;
				}
