		                       ...
		                       <div class="widget-main">
		                         ...
		                         <table  class="table table-striped table-bordered table-hover detail-tab">
			                      ...
			                      <tr>
			                             ...
			                             <th>公司名称:</th>
			                             <td><c:out value="${bean.businessAttribute2}"></c:out>   </td>
			                             <th>价格单位:</th>
			                             <td><c:out value="${bean.businessAttribute3}"></c:out>   </td>
			                          ...
			                          <tr>
			                            <th>备注:</th>
			                            <td colspan="3"><c:out value="${bean.businessAttribute70}"></c:out>   </td>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: getRootPath()+'/price/ajaxPriceInstanceList?id=${bean.id}',
					datatype: "json",
				    mtype: 'POST',  
					height: "100%",
					colNames:[
...
,'剩余库存能力(天)'
					...
					colModel:[
			{name:'businessAttribute2',index:'businessAttribute2', width:90,editable: true,editoptions:{size:"20",maxLength:"13"}},
			{name:'businessAttribute3',index:'businessAttribute3', width:90,editable: true,editoptions:{size:"20",maxLength:"19"}},
			{name:'businessAttribute4',index:'businessAttribute4', width:90,editable: true,editoptions:{size:"20",maxLength:"200"}},
			{name:'businessAttribute5',index:'businessAttribute5', width:90,editable: true,editoptions:{size:"20",maxLength:"14"}},
			{name:'businessAttribute6',index:'businessAttribute6', width:90,editable: true,editoptions:{size:"20",maxLength:"14"}},
			{name:'businessAttribute7',index:'businessAttribute7', width:90,editable: true,editoptions:{size:"20",maxLength:"14"}},
			{name:'businessAttribute8',index:'businessAttribute8', width:90,editable: true,editoptions:{size:"20",maxLength:"14"}},
			{name:'businessAttribute9',index:'businessAttribute9', width:90,editable: true,editoptions:{size:"20",maxLength:"14"}},
			{name:'businessAttribute10',index:'businessAttribute10', width:90,editable: true,editoptions:{size:"20",maxLength:"14"}},
			{name:'businessAttribute11',index:'businessAttribute11', width:90,editable: true,editoptions:{size:"20",maxLength:"14"}},
			{name:'businessAttribute12',index:'businessAttribute12', width:90,editable: true,editoptions:{size:"20",maxLength:"14"}},
			{name:'businessAttribute13',index:'businessAttribute13', width:90,editable: true,editoptions:{size:"20",maxLength:"14"}},
			{name:'businessAttribute14',index:'businessAttribute14', width:90,editable: true,editoptions:{size:"20",maxLength:"14"}},
					], 
