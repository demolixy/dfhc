...
var objKeys=['displayName','phoneNumber'];
//查询操作
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
				    ...
				    mtype: 'POST',  
					height: 250,
					colNames:['truckNo','phoneNumber',
'<%=IRowNumberConstants.TABLE_COLUMN_DISPLAY.get("truckNo")%>'
,'<%=IRowNumberConstants.TABLE_COLUMN_DISPLAY.get("phoneNumber")%>'

],
					colModel:[
					    {name:'truckNo',index:'truckNo',width:90, editable:true,hidedlg:true,hidden:true},		
					    {name:'phoneNumber',index:'phoneNumber',width:90, editable:true,hidedlg:true,hidden:true},		
