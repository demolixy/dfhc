		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: getRootPath()+'/ladingbill/ajaxList?${queryString}&statuss=' + statuss + "&loadingNoticeLoading=loadingNoticeLoading",
					datatype: "json",
				    mtype: 'POST',  
					height: '100%',
					colNames:[
...
,'<%=ILadingBillConstants.TABLE_COLUMN_DISPLAY.get("remark")%>'
			...
			{name:'inTime',index:'inTime',width:90, editable:true, sorttype:"date", formatter:formatDateRow},
