...
<span class="choose_ref"  onclick="javascript:getNewReference('<%=request.getContextPath()%>/logisticscompany/reference?referenceInputType=radio','form.logisticsCompanyId,form.logisticsCompany');">选择</span>
						...
						<div class="input-prepend">
						  ...
						  <div class="input-prepend">
							...
							<div class="input-prepend">
							  <span class="add-on">收货仓库</span><input class="m-wrap" name="receivingAddress" id="receivingAddress" type="text"  						maxLength="20" />
							</div>
...
,'发货日期','运输公司','产品类型','产品名称','接货人','电话','收货地址','车牌号码','实际发货数量','实际里程','结算运价','运费','司机姓名','联系方式','身份证','破包数'
],
					colModel:[
			...
			{name:'productType',index:'productType', width:90,editable: true},
			...
			{name:'deliveryNumber',index:'deliveryNumber', width:90,editable: true}
					], 
