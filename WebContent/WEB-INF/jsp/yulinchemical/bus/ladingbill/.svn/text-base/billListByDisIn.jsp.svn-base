...
,'序号','发货日期','区域','客户名称','产品名称','等级','提货人','提货人电话','省份','地区','发货详细地址','实际发货数量','单价','实际发货金额'
],
					colModel:[
			...
			{name:'receivingAddress',index:'receivingAddress', width:120,editable: true},
			{name:'actualShippingWeight',index:'actualShippingWeight', width:120,editable: true},
			{name:'productUnitPrice',index:'productUnitPrice', width:90,editable: true},
			{name:'actualShippingAmount',index:'actualShippingAmount', width:120,editable: true}
