 ...
 <!--begin  新增 -->
  ...
  <div class="ui-jqdialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix"  style="cursor: move;">
   ...
   <form name="updateForm" id="updateForm" class="FormGrid ui_inner_form" >
     ...
     <div class="EditTable operate_div" >
       <a href="javascript:void(0)" id="sData" class="fm-button ui-state-default ui-corner-all fm-button-icon-left" onclick="javascript:submitInsertAjax('<%=request.getContextPath()%>/order/update',$(updateForm).serialize())">
       <i class="icon-ok"></i>
            更新</a>
       <a href="javascript:void(0)" id="cData" class="cancel fm-button ui-state-default ui-corner-all fm-button-icon-left">
      <i class="icon-remove"></i> 
...
--%>
							<div class="input-prepend">
							  <span class="add-on"><%=IOrderConstants.TABLE_COLUMN_DISPLAY.get("shipMode")%></span><input type="text" class="m-wrap"  name="shipMode" />			<input type="hidden" class="m-wrap"  name="shipModeId" />
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: getRootPath()+'/orderproductdetail/ajaxList2?orderToLadingBill=orderToLadingBill&operation=${operation}&remainderCarNumIsNotZero=remainderCarNumIsNotZero',
					datatype: "json",
				    mtype: 'POST',  
					height: "100%",
					colNames:[
'订单编号','客户名称','产品名称','发运方式','计划发运量','车数','已分配车数','计划提货日期','有效期至','备注'
			...
			{name:'productName',index:'productName', width:110,editable: true,editoptions:{size:"20",maxLength:"200"}},
			{name:'shipMode',index:'shipMode', width:90,editable: true,editoptions:{size:"20",maxLength:"200"}},
			{name:'plannedVolume',index:'plannedVolume', width:90,editable: true,editoptions:{size:"20",maxLength:"8"}},
			{name:'carNum',index:'carNum', width:90,editable: true,editoptions:{size:"20",maxLength:"8"}},
			{name:'assignedCarNumBer',index:'assignedCarNumBer', width:90,editable: true,editoptions:{size:"20",maxLength:"8"}},
			{name:'deliveryStarDate',index:'deliveryStarDate',sorttype :"date", formatter: formatDateShow},
			{name:'deliveryEndDate',index:'deliveryEndDate',sorttype :"date",formatter: formatDateShow},
			{name:'remark',index:'remark', width:150,editable: true,editoptions:{size:"20",maxLength:"8"}},
					], 
...
// 				      position:"last" }) ;
				...
				//新增弹出
			     ...
			     function updateShow(){
 				   ...
 				   window.location.href="${pageContext.request.contextPath}/order/toUpdateOrder?id="+updateDate+"&pcode=${pcode}";
                ...
                <%--    $.ajax({
					...
					function to_detail(){
	                    ...
	                    window.location.href="${pageContext.request.contextPath}/orderproductdetail/toDetail?flag=${flag}&id="+id+"&pcode=${pcode}&orderToLadingBill=orderToLadingBill&operation=${operation}";
