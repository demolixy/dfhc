...
// 				      onClickButton: addShow, position:"last" }) ;
		     ...
		     function invalidShow(){
				...
				function showDetail(){
                    ...
                    var pointer=$(".cbox:checked").parents("tr");
                    var updateDate=$(pointer).attr("id");
                    window.location = "${pageContext.request.contextPath}/ladingbill/ladingBillDetailForBillType?operation=${operation}&ladingBillId=" + updateDate + "&date=" + new Date();
				}
			});
			//打印
			function printing(){
                ...
                var pointer=$(".cbox:checked").parents("tr");
                var updateDate=$(pointer).attr("id");
                window.location = "${pageContext.request.contextPath}/ladingbill/printladingbill?ladingBillId=" + updateDate + "&date=" + new Date();
			}
