		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: getRootPath()+'/ladingbill/ajaxList?toBeSettlement=toBeSettlement&ladingBillStatus=08',
					datatype: "json",
				    mtype: 'POST',  
					height: '100%',
					colNames:[
...
// 				      position:"last" }) ;
				...
				//查看
				  jQuery(grid_selector) .navButtonAdd(pager_selector,
					{ caption:"",title:"生成结算单", buttonicon:"icon-check red",
				...
				function showDetail(){
                    ...
                    if(confirm("是否确认生成结算单？")){
                    	$.ajax({
                            type: "POST",
                            url: "<%=request.getContextPath()%>/receiptconfletter/settlement?date="+new Date(),
