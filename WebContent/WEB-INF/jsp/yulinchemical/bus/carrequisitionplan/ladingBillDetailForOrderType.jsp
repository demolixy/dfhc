		                  ...
		                  --%>         
		                         ...
		                         <table  class="table table-striped table-bordered table-hover detail-tab">
			                      ...
			                      <tr>
			                          ...
			                          <tr>
			                             ...
			                             <th>调拨库房:</th>
			                             <td><c:out value="${bean.requisitionWarehouse}"></c:out>  </td>
			                          ...
			                          <tr>
			                          	 <c:choose>
				                         	<c:when test="${ladingBillStatus == '01' || ladingBillStatus == '00'}">
												<th>作废原因:</th>
			                             		<td colspan="5">
			                             			<textarea rows="" cols="120" name="invalidReason"></textarea>	
			                             		</td>				                         	
				                         	</c:when>
				                         </c:choose>
			                          </tr>
		                   ...
		                   <div class="row">
							<div class="col-xs-12">
		                     ...
		                     <div class="opt-div">
		                         <c:choose>
		                         	<c:when test="${ladingBillStatus == '0' || ladingBillStatus == '01'}">
			                          <a href="javascript:void(0);" class="sub-btn-shi"  id="commit"   onclick="javascript:invalidShow();" > 作废</a>
...
// 				      position:"last" }) ;
			...
			function doSaveOrCommit(flag){
				...
				$.ajax({
				    type:'post',//可选get
				    url:"${pageContext.request.contextPath}/ladingbill/insertOrUpdateCarrequisition?carRequisitionId=" + carRequisitionId + "&flag=" + flag + "&date=" + new Date(),
				    ...
				    success:function(data,status){
					  if(data.status=="0"){
						  ...
						  alert(data.message);
				   	     	...
				   	     	alert(data.message);
// 		                    window.location.href="${pageContext.request.contextPath}/carrequisitionplan?operation=${operation}";
		                    window.location = '${uri}';
				   	   }
				   },
				   error:function(xhr,s1,s2){
