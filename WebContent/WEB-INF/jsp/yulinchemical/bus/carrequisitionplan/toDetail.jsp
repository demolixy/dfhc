...
function ajaxPicUpload(){
	$.ajaxFileUpload({ 
	     ...
	     url: '<%=request.getContextPath()%>/pubController/picUpload?id=${bean.id}&billType=03',  
...
$(function(){
	$(".closebtn").click(function(){
		...
		$.ajax({
            ...
            data:{"imgPath":imgPath[1].toString(), "id":'${bean.id}'},		 
            dataType: "json",
	                        ...
	                        success: function(data,status) {
	                	   	   if(data.status=="0"){
	                	   	       alert(data.message);
	                    	   		...
	                    	   		alert(data.message);
	        	                    window.location.href="${pageContext.request.contextPath}/carrequisitionplan/toDetail?operation=${operation}&carRequisitionPlanId=${bean.id}";
	                	   	   }
	                       },
	                       error:function(xhr,s1,s2){
	                       	var message = xhr.responseText;
