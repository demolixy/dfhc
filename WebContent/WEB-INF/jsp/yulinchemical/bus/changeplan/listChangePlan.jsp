<%@page import="com.dfhc.bus.changeplan.IChangePlanConstants" %>
  ...
  <div class="ui-jqdialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix"  style="cursor: move;">
   ...
   <div class="control-group">
			 <div class="controls">
							...
							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("oldPlanId")%></span><input class="m-wrap" name="oldPlanId"  type="text"  						maxLength="19" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("oldBillType")%></span><%=RmJspHelper.getSelectField("oldBillType", -1, RmGlobalReference.get(ISystemConstant.DICTIONARY_BILL_TYPE), "", "inputName='" + IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("oldBillType") + "'  ", true) %>							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("newPlanId")%></span><input class="m-wrap" name="newPlanId"  type="text"  						maxLength="19" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("newBillType")%></span><%=RmJspHelper.getSelectField("newBillType", -1, RmGlobalReference.get(ISystemConstant.DICTIONARY_BILL_TYPE), "", "inputName='" + IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("newBillType") + "'  ", true) %>							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("modifyApplyPerson")%></span><input class="m-wrap" name="modifyApplyPerson"  type="text"  						maxLength="200" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("modifyOperator")%></span><input class="m-wrap" name="modifyOperator"  type="text"  						maxLength="200" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("modifyOperatorId")%></span><input class="m-wrap" name="modifyOperatorId"  type="text"  						maxLength="19" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("changeTime")%></span><input name="changeTime"  class="m-wrap m-ctrl-medium date-picker" readonly size="16" type="text" value="" inputName="<%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("changeTime")%>" />
							</div>
     ...
     <div class="EditTable operate_div" >
       <a href="javascript:void(0)" id="sData" class="fm-button ui-state-default ui-corner-all fm-button-icon-left" onclick="javascript:submitInsertAjax('<%=request.getContextPath()%>/changeplan/insert',$(insertForm).serialize())">
       <i class="icon-ok"></i>
               保存</a>
   ...
   <form name="updateForm" id="updateForm" class="FormGrid ui_inner_form" >
           ...
           <div class="control-group">
							...
							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("oldPlanId")%></span><input class="m-wrap" name="oldPlanId" id="oldPlanId" type="text"  						maxLength="19" />
							</div>
							...
							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("newPlanId")%></span><input class="m-wrap" name="newPlanId" id="newPlanId" type="text"  						maxLength="19" />
							</div>
							...
							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("modifyApplyPerson")%></span><input class="m-wrap" name="modifyApplyPerson" id="modifyApplyPerson" type="text"  						maxLength="200" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("modifyOperator")%></span><input class="m-wrap" name="modifyOperator" id="modifyOperator" type="text"  						maxLength="200" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("modifyOperatorId")%></span><input class="m-wrap" name="modifyOperatorId" id="modifyOperatorId" type="text"  						maxLength="19" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("changeTime")%></span><input name="changeTime" id="changeTime"  class="m-wrap m-ctrl-medium date-picker" readonly size="16" type="text" value="" inputName="<%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("changeTime")%>" />
							</div>
     ...
     <div class="EditTable operate_div" >
       <a href="javascript:void(0)" id="sData" class="fm-button ui-state-default ui-corner-all fm-button-icon-left" onclick="javascript:submitInsertAjax('<%=request.getContextPath()%>/changeplan/update',$(updateForm).serialize())">
       <i class="icon-ok"></i>
            更新</a>
       <a href="javascript:void(0)" id="cData" class="cancel fm-button ui-state-default ui-corner-all fm-button-icon-left">
      <i class="icon-remove"></i> 
   ...
   <form name="deleteForm" id="deleteForm" class="FormGrid ui_inner_form"  method="post"  >
     ...
     <div class="EditTable operate_div" >
       <a href="javascript:void(0)" id="sData" class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn-danger" onclick="javascript:_delete('<%=request.getContextPath()%>/changeplan/logicDelete?pcode=${pcode }');">
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: getRootPath()+'/changeplan/ajaxList',
					datatype: "json",
				    mtype: 'POST',  
					height: 550,
					colNames:[
'<%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("oldPlanId")%>'
,'<%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("oldBillType")%>'
,'<%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("newPlanId")%>'
,'<%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("newBillType")%>'
,'<%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("modifyApplyPerson")%>'
,'<%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("modifyOperator")%>'
,'<%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("modifyOperatorId")%>'
,'<%=IChangePlanConstants.TABLE_COLUMN_DISPLAY.get("changeTime")%>'
],
					colModel:[
			...
			{name:'changeTime',index:'changeTime',width:90, editable:true, sorttype:"date",unformat: pickDate}
					...
					editurl: getRootPath()+'/changeplan/update',//nothing is saved
					caption: "变车管理列表展示",
					autowidth: true
			   ...
			   jQuery(grid_selector) .navButtonAdd(pager_selector,
				...
				//查询
			     ...
			     function updateShow(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<%=request.getContextPath()%>/changeplan/get/" + updateDate+"/"+new Date(),
                        dataType: "json",
