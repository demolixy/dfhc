   ...
   <div class="control-group">
			 <div class="controls">
							...
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerAvailableAmountConstants.TABLE_COLUMN_DISPLAY.get("customerId")%></span><input class="m-wrap" name="customerId"  type="text"  						maxLength="19" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerAvailableAmountConstants.TABLE_COLUMN_DISPLAY.get("customerName")%></span><input class="m-wrap" name="customerName"  type="text"  						maxLength="200" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerAvailableAmountConstants.TABLE_COLUMN_DISPLAY.get("availableCredit")%></span><input class="m-wrap" name="availableCredit"  type="text"  						maxLength="19" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerAvailableAmountConstants.TABLE_COLUMN_DISPLAY.get("freezingAmount")%></span><input class="m-wrap" name="freezingAmount"  type="text"  						maxLength="19" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerAvailableAmountConstants.TABLE_COLUMN_DISPLAY.get("signature")%></span><input class="m-wrap" name="signature"  type="text"  						maxLength="32" />
							</div>
     ...
     <div class="EditTable operate_div" >
       <a href="javascript:void(0)" id="sData" class="fm-button ui-state-default ui-corner-all fm-button-icon-left" onclick="javascript:submitInsertAjax('<%=request.getContextPath()%>/customeravailableamount/insert',$(insertForm).serialize())">
       <i class="icon-ok"></i>
               保存</a>
...
<!-- 							<div class="input-prepend"> -->
<%-- 							  <span class="add-on"><%=ICustomerAvailableAmountConstants.TABLE_COLUMN_DISPLAY.get("customerId")%></span> --%>
<!-- 							</div> -->
							<input class="m-wrap" name="customerId" id="customerId" type="hidden"  						maxLength="19" />
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerAvailableAmountConstants.TABLE_COLUMN_DISPLAY.get("customerName")%></span><input class="m-wrap" readonly="readonly" name="customerName" id="customerName" type="text"  						maxLength="200" />
							</div>
							...
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerAvailableAmountConstants.TABLE_COLUMN_DISPLAY.get("freezingAmount")%></span><input class="m-wrap" name="freezingAmount" readonly="readonly" id="freezingAmount" type="text"  						maxLength="19" />
							</div>
     ...
     <div class="EditTable operate_div" >
       <a href="javascript:void(0)" id="sData" class="fm-button ui-state-default ui-corner-all fm-button-icon-left" onclick="javascript:submitInsertAjax('<%=request.getContextPath()%>/customeravailableamount/update',$(updateForm).serialize())">
       <i class="icon-ok"></i>
            更新</a>
       <a href="javascript:void(0)" id="cData" class="cancel fm-button ui-state-default ui-corner-all fm-button-icon-left">
      <i class="icon-remove"></i> 
   ...
   <form name="form" id="form" class="FormGrid ui_inner_form" method="post" >
           ...
           <div class="control-group">
							...
							<div class="input-prepend">
							  <span class="add-on"><%=ICustomerAvailableAmountConstants.TABLE_COLUMN_DISPLAY.get("customerName")%></span>
   ...
   <form name="deleteForm" id="deleteForm" class="FormGrid ui_inner_form"  method="post"  >
     ...
     <div class="EditTable operate_div" >
       <a href="javascript:void(0)" id="sData" class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn-danger" onclick="javascript:_delete('<%=request.getContextPath()%>/customeravailableamount/logicDelete?pcode=${pcode }');">
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: getRootPath()+'/customeravailableamount/ajaxList',
					datatype: "json",
				    mtype: 'POST',  
					height:"100%",
					colNames:[
			   ...
			   jQuery(grid_selector) .navButtonAdd(pager_selector,
				...
				//查询
			     ...
			     function updateShow(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<%=request.getContextPath()%>/customeravailableamount/get/" + updateDate+"/"+new Date(),
                        dataType: "json",
                      ...
                      $("#portlet-config-edit").find("input[id=availableCredit]").val(data.bean.availableCredit);
                      $("#portlet-config-edit").find("input[id=freezingAmount]").val(data.bean.freezingAmount);
