...
function confirmSubmitlu(){
	...
	$.ajax({
		    type:'post',//可选get
		    url:"${pageContext.request.contextPath}/logisticscostsettlement/doConfirmSubmit",
		    ...
		    success:function(data,status){
			  if(data.status=="0"){
				  ...
				  alert(data.message);
		   	     	...
		   	     	alert(data.message);
	                window.location.href="${pageContext.request.contextPath}/logisticscostsettlement/listSettleByTrain?operation=${operation}&status=00&pcode=${pcode}";
		   	   }
		   },
...
,'<%=ILadingBillConstants.TABLE_COLUMN_DISPLAY.get("remark")%>'
			...
			{name:'plannedMileage',index:'plannedMileage', width:90,editable: true},
			{name:'factMileage',index:'factMileage', width:90,editable: true},
			{name:'valuationMileage',index:'valuationMileage', width:90,editable: true},
