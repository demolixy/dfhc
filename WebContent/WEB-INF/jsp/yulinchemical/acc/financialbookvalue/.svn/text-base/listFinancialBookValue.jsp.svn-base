<%@page import="com.dfhc.acc.financialbookvalue.IFinancialBookValueConstants" %>
  ...
  <div class="ui-jqdialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix"  style="cursor: move;">
   ...
   <div class="control-group">
			 <div class="controls">
							...
							<div class="input-prepend">
							  <span class="add-on"><%=IFinancialBookValueConstants.TABLE_COLUMN_DISPLAY.get("customerId")%></span><input class="m-wrap" name="customerId"  type="text"  						maxLength="19" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=IFinancialBookValueConstants.TABLE_COLUMN_DISPLAY.get("customerName")%></span><input class="m-wrap" name="customerName"  type="text"  						maxLength="200" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=IFinancialBookValueConstants.TABLE_COLUMN_DISPLAY.get("balance")%></span><input class="m-wrap" name="balance"  type="text"  						maxLength="19" />
							</div>

							
							<div class="input-prepend">
							  <span class="add-on"><%=IFinancialBookValueConstants.TABLE_COLUMN_DISPLAY.get("signature")%></span><input class="m-wrap" name="signature"  type="text"  						maxLength="32" />
							</div>
     ...
     <div class="EditTable operate_div" >
       <a href="javascript:void(0)" id="sData" class="fm-button ui-state-default ui-corner-all fm-button-icon-left" onclick="javascript:submitInsertAjax('<%=request.getContextPath()%>/financialbookvalue/insert',$(insertForm).serialize())">
       <i class="icon-ok"></i>
               保存</a>
   ...
   <form name="updateForm" id="updateForm" class="FormGrid ui_inner_form" >
           ...
           <div class="control-group">
							...
							<div class="input-prepend">
							  <span class="add-on"><%=IFinancialBookValueConstants.TABLE_COLUMN_DISPLAY.get("customerId")%></span><input class="m-wrap" name="customerId" id="customerId" type="text"  						maxLength="19" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=IFinancialBookValueConstants.TABLE_COLUMN_DISPLAY.get("customerName")%></span><input class="m-wrap" name="customerName" id="customerName" type="text"  						maxLength="200" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=IFinancialBookValueConstants.TABLE_COLUMN_DISPLAY.get("balance")%></span><input class="m-wrap" name="balance" id="balance" type="text"  						maxLength="19" />
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=IFinancialBookValueConstants.TABLE_COLUMN_DISPLAY.get("signature")%></span><input class="m-wrap" name="signature" id="signature" type="text"  						maxLength="32" />
							</div>
     ...
     <div class="EditTable operate_div" >
       <a href="javascript:void(0)" id="sData" class="fm-button ui-state-default ui-corner-all fm-button-icon-left" onclick="javascript:submitInsertAjax('<%=request.getContextPath()%>/financialbookvalue/update',$(updateForm).serialize())">
       <i class="icon-ok"></i>
            更新</a>
       <a href="javascript:void(0)" id="cData" class="cancel fm-button ui-state-default ui-corner-all fm-button-icon-left">
      <i class="icon-remove"></i> 
   ...
   <form name="form" id="form" class="FormGrid ui_inner_form" method="post" >
           ...
           <div class="control-group">
							...
							<div class="input-prepend">
							  <span class="add-on"><%=IFinancialBookValueConstants.TABLE_COLUMN_DISPLAY.get("customerName")%></span>
   ...
   <form name="deleteForm" id="deleteForm" class="FormGrid ui_inner_form"  method="post"  >
     ...
     <div class="EditTable operate_div" >
       <a href="javascript:void(0)" id="sData" class="fm-button ui-state-default ui-corner-all fm-button-icon-left btn-danger" onclick="javascript:_delete('<%=request.getContextPath()%>/financialbookvalue/logicDelete?pcode=${pcode }');">
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: getRootPath()+'/financialbookvalue/ajaxList',
					datatype: "json",
				    mtype: 'POST',  
					height: '100%',
					colNames:[
'<%=IFinancialBookValueConstants.TABLE_COLUMN_DISPLAY.get("customerName")%>'
,'<%=IFinancialBookValueConstants.TABLE_COLUMN_DISPLAY.get("balance")%>'
],
					colModel:[
			{name:'customerName',index:'customerName', width:200,editable: true,editoptions:{size:"20",maxLength:"200"}},
			{name:'balance',index:'balance', width:200,editable: true,editoptions:{size:"20",maxLength:"19"}},
					], 
					...
					editurl: getRootPath()+'/financialbookvalue/update',//nothing is saved
					caption: "客户财务账面金额列表展示",
					autowidth: true
...
// 				      position:"last" }) ;
				...
				//查询
			     ...
			     function updateShow(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<%=request.getContextPath()%>/financialbookvalue/get/" + updateDate+"/"+new Date(),
                        dataType: "json",
                      ...
                      $("#portlet-config-edit").find("input[id=balance]").val(data.bean.balance);
