...
<span class="choose_ref"  onclick="javascript:getNewReference('<%=request.getContextPath()%>/receiptconfletter/reference?referenceInputType=radio','insertForm.invoiceSettlementId,insertForm.invoiceSettlementIdName');">选择</span>
   ...
   <form name="updateForm" id="updateForm" class="FormGrid ui_inner_form" >
           ...
           <div class="control-group">
							...
							<div class="input-prepend">
							  <span class="add-on"><%=ILadingBillConstants.TABLE_COLUMN_DISPLAY.get("orderPlanId")%></span>						<input type="text" class="m-wrap"  name="orderPlanId" id="orderPlanId" />
<span class="choose_ref"  onclick="javascript:getNewReference('<%=request.getContextPath()%>/order/reference?referenceInputType=radio','insertForm.orderPlanId,insertForm.orderPlanIdName');">选择</span>
							</div>
							...
							<div class="input-prepend">
							  <span class="add-on"><%=ILadingBillConstants.TABLE_COLUMN_DISPLAY.get("freightSettlementId")%></span>						<input type="text" class="m-wrap"  name="freightSettlementId" id="freightSettlementId" />
<span class="choose_ref"  onclick="javascript:getNewReference('<%=request.getContextPath()%>/logisticscostsettlement/reference?referenceInputType=radio','insertForm.freightSettlementId,insertForm.freightSettlementIdName');">选择</span>
							</div>

							<div class="input-prepend">
							  <span class="add-on"><%=ILadingBillConstants.TABLE_COLUMN_DISPLAY.get("invoiceSettlementId")%></span>						<input type="text" class="m-wrap"  name="invoiceSettlementId" id="invoiceSettlementId" />
<span class="choose_ref"  onclick="javascript:getNewReference('<%=request.getContextPath()%>/receiptconfletter/reference?referenceInputType=radio','insertForm.invoiceSettlementId,insertForm.invoiceSettlementIdName');">选择</span>
							</div>
...
<!-- begin  详情 -->
		         ...
		         <%--                
		                      <a href="javascript:void(0)" onclick="confirmPurchase('${bean.id}');" title="确认结算">
		                           
		                           <i class="icon-check" ></i>
		                         
		                         </a>
		                      <a href="javascript:void(0)" onclick="confirmSubmit('${bean.id}');" title="确认提交">
		                       ...
		                       <div class="widget-main">
		                         ...
		                         <table  class="table table-striped table-bordered table-hover detail-tab">
			                      ...
			                      <tr>
			                             ...
			                             <th><%=IReceiptConfLetterConstants.TABLE_COLUMN_DISPLAY.get("documentNumber")%>:</th>
			                             <td><c:out value="${bean.documentNumber}"></c:out>   </td>
			                             <th><%=IReceiptConfLetterConstants.TABLE_COLUMN_DISPLAY.get("customerName")%>:</th>
			                             <td>
											<c:out value="${bean.customerName }"></c:out>
			                              </td>
			                             <th><%=IReceiptConfLetterConstants.TABLE_COLUMN_DISPLAY.get("settlementStartDate")%>:</th>
			                             <td>
			                             	<fmt:formatDate value="${bean.settlementStartDate }" pattern="yyyy-MM-dd"/>
			                             </td>
			                          ...
			                          <tr>
			                             ...
			                             <th><%=IReceiptConfLetterConstants.TABLE_COLUMN_DISPLAY.get("settlementEndDate")%>:</th>
			                             <td><fmt:formatDate value="${bean.settlementStartDate }" pattern="yyyy-MM-dd"/>  </td>
			                             <th><%=IReceiptConfLetterConstants.TABLE_COLUMN_DISPLAY.get("applyPerson")%>:</th>
			                             <td><c:out value="${bean.applyPerson}"></c:out>  </td>
			                             <th><%=IReceiptConfLetterConstants.TABLE_COLUMN_DISPLAY.get("applyTime")%>:</th>
			                          ...
			                          <tr>
			                             ...
			                             <th><%=IReceiptConfLetterConstants.TABLE_COLUMN_DISPLAY.get("totalAmount")%>:</th>
			                             <td><c:out value="${bean.totalAmount}"></c:out>   </td>
			                             <th><%=IReceiptConfLetterConstants.TABLE_COLUMN_DISPLAY.get("bookBalance")%>:</th>
			                             <td><c:out value="${bean.bookBalance}"></c:out>   </td>
			                             <th><%=IReceiptConfLetterConstants.TABLE_COLUMN_DISPLAY.get("status")%>:</th>
			                             <td>
			                             <bean:define id="status" name="bean" property="status"/>
										<c:out value="<%=RmGlobalReference.get(ISystemConstant.DICTIONARY_CONFIRMATION_LETTER_STATUS, status)%>"/>  </td>
			                          ...
			                          <tr>
			                             ...
			                             <th><%=IReceiptConfLetterConstants.TABLE_COLUMN_DISPLAY.get("actualSettlementAmount")%>:</th>
			                             <td><c:out value="${bean.actualSettlementAmount}"></c:out>  </td>
			                             <th></th>
			                             <td></td>
			                             <th></th>
			                             <td> </td>
					...
					<div class="opt-div">
		                          ...
		                          <a href="javascript:void(0);" class="sub-btn-shi"  id="commit"   onclick="returnStatus('${bean.id}');" > 退回</a>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: getRootPath()+'/ladingbill/ajaxList?invoiceSettlementId=${bean.id}',
					datatype: "json",
				    mtype: 'POST',  
					height: '100%',
					colNames:[
...
,'<%=ILadingBillConstants.TABLE_COLUMN_DISPLAY.get("remark")%>'
					...
					colModel:[
			{name:'orderPlanCode',index:'orderPlanCode',editable: true,editoptions:{size:"20",maxLength:"13"}},
			{name:'ladingBillCode',index:'ladingBillCode',editable: true,editoptions:{size:"20",maxLength:"13"}},
			{name:'billType',index:'billType',editable: true,editoptions:{size:"20",maxLength:"2"}},
			{name:'shipMode',index:'shipMode',editable: true,editoptions:{size:"20",maxLength:"100"}},
			{name:'productType',index:'productType',editable: true,editoptions:{size:"20",maxLength:"200"}},
			...
			{name:'licensePlate',index:'licensePlate',editable: true,editoptions:{size:"20",maxLength:"100"}},
			{name:'driverName',index:'driverName',editable: true,editoptions:{size:"20",maxLength:"200"}},
			{name:'driverIdCardNumber',index:'driverIdCardNumber',editable: true,editoptions:{size:"20",maxLength:"18"}},
			{name:'actualShippingWeight',index:'actualShippingWeight',editable: true,editoptions:{size:"20",maxLength:"14"}},
			{name:'emptyWeight',index:'emptyWeight',editable: true,editoptions:{size:"20",maxLength:"10"}},
			{name:'emptyPoundTime',index:'emptyPoundTime', editable:true, sorttype:"date",unformat: pickDate},
			{name:'fullWeight',index:'fullWeight',editable: true,editoptions:{size:"20",maxLength:"10"}},
			{name:'fullPoundTime',index:'fullPoundTime', editable:true, sorttype:"date",unformat: pickDate},
			{name:'invalidPerson',index:'invalidPerson',editable: true,editoptions:{size:"20",maxLength:"200"}},
			{name:'invalidTime',index:'invalidTime', editable:true, sorttype:"date",unformat: pickDate},
			{name:'invalidReason',index:'invalidReason',editable: true,editoptions:{size:"20",maxLength:"300"}},
			{name:'factMileage',index:'factMileage',editable: true,editoptions:{size:"20",maxLength:"12"}},
			{name:'valuationMileage',index:'valuationMileage',editable: true,editoptions:{size:"20",maxLength:"12"}},
			{name:'settlementFreight',index:'settlementFreight',editable: true,editoptions:{size:"20",maxLength:"19"}},
			{name:'yuanKmTon',index:'yuanKmTon',editable: true,editoptions:{size:"20",maxLength:"19"}},
			{name:'freight',index:'freight',editable: true,editoptions:{size:"20",maxLength:"19"}},
			{name:'receivingPerson',index:'receivingPerson',editable: true,editoptions:{size:"20",maxLength:"200"}},
			{name:'receivingAddress',index:'receivingAddress',editable: true,editoptions:{size:"20",maxLength:"300"}},
			{name:'receivingPersonPhone',index:'receivingPersonPhone',editable: true,editoptions:{size:"20",maxLength:"20"}},
			{name:'remark',index:'remark',editable: true,editoptions:{size:"20",maxLength:"200"}},
					], 
			   ...
			   /* jQuery(grid_selector) .navButtonAdd(pager_selector,
			    ...
			    /*  function updateShow(){
                    ...
                    $.ajax({
                      ...
                      $("#portlet-config-edit").find("input[id=billType]").val(data.bean.billType);
                      ...
                      $("#portlet-config-edit").find("input[id=ladingBillStatus]").val(data.bean.ladingBillStatus);
			...
			//退回
			function returnStatus(obj, flag){
				var url;
				if(flag){
					url = "<%=request.getContextPath()%>/receiptconfletter/updateStatus?id=" + obj.toString() + "&flag=" + flag + "&date=" + new Date();
				}else{
					if(!confirm("是否确认退回？")){
						return false;
					}
					
					url = "<%=request.getContextPath()%>/receiptconfletter/updateStatus?id=" + obj.toString() + "&date=" + new Date();
			...
			function confirmSubmit(obj){
				returnStatus(obj, 'confirmSubmit');
			}
			//确认结算
			function confirmPurchase(obj){
				returnStatus(obj, 'confirmPurchase');
			}
		</script>
	</body>
</html>
