   ...
   <form name="form" id="form" class="FormGrid ui_inner_form" method="post" >
           ...
           <div class="control-group">
							...
							<div class="input-prepend">
							  <span class="add-on">名称</span><input class="m-wrap" name="name" id="name" type="text"  />
							</div>
...
<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					url: getRootPath()+'/pubController/ajaxListPartyReference',
					datatype: "json",
				    mtype: 'POST',  
					height:280,
					colNames:['团体名称','团体类型id','团体类型名称','团体原始id','名称', '是否继承权限', '电子邮箱'],
					colModel:[
					    {name:'name',index:'name',hidedlg:true,hidden:true},     
                        {name:'party_type_id',index:'party_type_id'},
						{name:'party_type_id_name',index:'party_type_id_name'},
						{name:'old_party_id',index:'old_party_id'},
						{name:'name',index:'name' ,editable: false},
						{name:'is_inherit',index:'is_inherit',  editable: true,edittype:"text"},
