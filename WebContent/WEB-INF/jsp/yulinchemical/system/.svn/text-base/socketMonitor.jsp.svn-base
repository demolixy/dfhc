		...
		<script type="text/javascript">
			//var grid_data = ${grid_data};	
			 ...
			 <c:forEach items="${bean}" var="bean"> 
				...
				dataObj1['socket']= '${bean.socket}';
				dataObj1['in']= '${bean.in}';
				dataObj1['out']= '${bean.out}';
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
				    ...
				    mtype: 'POST',  
					height:"auto",
					colNames:['客户端socket标识','socket','输入流', '输出流'],
					colModel:[
                        {name:'clientId',index:'clientId', width:200,editable: true,editoptions:{size:"20",maxLength:"200"}},
                        {name:'socket',index:'socket', width:200,editable: true,editoptions:{size:"20",maxLength:"200"}},
                        {name:'in',index:'in', width:200,editable: true,editoptions:{size:"20",maxLength:"200"}},
                        {name:'out',index:'out', width:200,editable: true,editoptions:{size:"20",maxLength:"200"}}
					], 
