...
<head>
	...
	<script type="text/javascript" src="${ctx }/editor-app/libs/jquery_1.11.0/jquery.js"></script>
	<script type="text/javascript" src="${ctx }/js/common/bootstrap.min.js"></script>
	<script type="text/javascript" src="${ctx }/js/bootstrap/bootstrap-datepicker.js"></script>
	<script type="text/javascript" src="${ctx }/js/bootstrap/bootstrap-timepicker.js"></script>
...
<body>
	<form action="${ctx }/sampleleave/task/complete/${task.id}" class="form-horizontal" method="post" onsubmit="beforeSend()">
