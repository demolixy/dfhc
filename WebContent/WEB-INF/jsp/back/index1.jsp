...
<html lang="en">
	...
	.tu_div{text-align: center;margin-top:50px;}
					...
					<div class="row">
					  ...
					  <div class="col-xs-12">
					    ...
					    <div class="col-xs-4 tu_div" >
					     ...
					     <div class="col-xs-4 tu_div">
					      <span>副产品今日价格</span>
					      <span><img alt="" src="${pageContext.request.contextPath }/images/logo.png"/></span>
					    </div>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "local",
					height: 250,
					colNames:['全选 ', 'ID','Last Sales','Name', 'Stock', 'Ship via','Notes'],
					colModel:[
