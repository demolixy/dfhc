...
(
   ...
   IS_ALLOW_HANGING_USER  char(1)  comment '$RM_YES_NOT=是、否{
            0=否,
            1=是
            }',
   IS_ALLOW_HANGING_ROLE  char(1)  comment '$RM_YES_NOT=是、否{
            0=否,
            1=是
            }',                        
   primary key (ID)
...
MODIFY_IP VARCHAR(45),
MODIFY_USER_ID BIGINT,
CREATE_TIME datetime default null,/*===为了与用户代码同步2016-01-08加入===*/
CREATE_USER_NAME varchar(100) default null,/*===为了与用户代码同步2016-01-08加入===*/
ATTRIBUTE1 varchar(100) default null,/*===为了与用户代码同步2016-01-08加入===*/
ATTRIBUTE2 varchar(100) default null,/*===为了与用户代码同步2016-01-08加入===*/
ATTRIBUTE3 varchar(100) default null,/*===为了与用户代码同步2016-01-08加入===*/
ATTRIBUTE4 varchar(100) default null,/*===为了与用户代码同步2016-01-08加入===*/
ATTRIBUTE5 varchar(100) default null/*===为了与用户代码同步2016-01-08加入===*/
);
...
INSERT INTO RM_USER (ID, NAME, LOCK_STATUS, LOGIN_ID, PASSWORD, AUTHEN_TYPE, ORGANIZATION_ID, EMPLOYEE_ID, EMAIL, ADMIN_TYPE, DESCRIPTION, AGENT_STATUS, LOGIN_STATUS, LAST_LOGIN_DATE, LAST_LOGIN_IP, LOGIN_SUM, LAST_CUSTOM_CSS, IS_AFFIX, FUNCTION_PERMISSION, DATA_PERMISSION, CUSTOM1, CUSTOM2, CUSTOM3, CUSTOM4, CUSTOM5, CUSTOM_XML, USABLE_STATUS, MODIFY_DATE, MODIFY_IP, MODIFY_USER_ID, CREATE_USER_NAME, CREATE_TIME, ATTRIBUTE1, ATTRIBUTE2, ATTRIBUTE3, ATTRIBUTE4, ATTRIBUTE5) VALUES (1000201100000000001, 'ADMIN', '1', 'admin', 'zCc5xk_vsZk', null, '', null, 'admin@quickbundle.org', '3', '', null, '1', '2016-05-10 11:42:00', '0:0:0:0:0:0:0:1', 4032, null, null, null, null, null, null, null, null, null, null, '1', '2011-07-14 00:32:16', '0:0:0:0:0:0:0:1', null, null, null, null, null, null, null, null);
