...
(
   ...
   IS_ALLOW_HANGING_USER  char(1) ,
   IS_ALLOW_HANGING_ROLE  char(1) ,    
...
MODIFY_IP VARCHAR2(45),
MODIFY_USER_ID NUMBER(19),
CREATE_TIME date default null,/*===为了与用户代码同步2016-01-08加入===*/
CREATE_USER_NAME varchar2(100) default null,/*===为了与用户代码同步2016-01-08加入===*/
ATTRIBUTE1 varchar2(100) default null,/*===为了与用户代码同步2016-01-08加入===*/
ATTRIBUTE2 varchar2(100) default null,/*===为了与用户代码同步2016-01-08加入===*/
ATTRIBUTE3 varchar2(100) default null,/*===为了与用户代码同步2016-01-08加入===*/
ATTRIBUTE4 varchar2(100) default null,/*===为了与用户代码同步2016-01-08加入===*/
ATTRIBUTE5 varchar2(100) default null/*===为了与用户代码同步2016-01-08加入===*/
);
