 ...
 */
@Repository
public class UserDao extends RmSqlSessionDaoSupport implements IUserConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<UserVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
