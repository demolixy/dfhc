 ...
 */
@Repository
public class RoleDao extends RmSqlSessionDaoSupport implements IRoleConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<RoleVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
