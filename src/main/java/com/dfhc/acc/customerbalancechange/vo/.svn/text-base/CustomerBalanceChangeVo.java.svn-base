 ...
 *
 * 文件名称：  CustomerBalanceChangeVo.java
 *
 * 功能描述：  客户余额变动值对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.acc.customerbalancechange.vo;
 ...
 * @see 参见的类
 */
public class CustomerBalanceChangeVo extends RmValueObject{
    ...
    /**
     * financialBookValueId 表示：财务账面金额ID
     */
    private  String  financialBookValueId;
    /**
     * customerId 表示：客户ID
     */
     ...
     * nowBalance 表示：财务余额
     */
    private  java.math.BigDecimal  nowBalance;
    /**
     * digest 表示：摘要
     */
    private  String  digest;
    /**
     * relevanceBillsId 表示：关联单据ID
     */
    private  String  relevanceBillsId;
    /**
     * amountDirection 表示：金额方向
     */
     ...
     * @return 财务账面金额ID
     */
    public  String  getFinancialBookValueId(){
        return financialBookValueId;
    }
    /**
     * 设置财务账面金额ID
     * @param financialBookValueId 财务账面金额ID
     */
    public  void  setFinancialBookValueId(String financialBookValueId){
        this.financialBookValueId = financialBookValueId;
    }
    /**
     * 获取客户ID 
     * @return 客户ID
    ...
    /**
     * 设置财务余额
     * @param nowBalance 财务余额
     */
    public  void  setNowBalance(java.math.BigDecimal nowBalance){
     ...
     * @return 关联单据ID
     */
    public  String  getRelevanceBillsId(){
        return relevanceBillsId;
    }
    /**
     * 设置关联单据ID
     * @param relevanceBillsId 关联单据ID
     */
    public  void  setRelevanceBillsId(String relevanceBillsId){
        this.relevanceBillsId = relevanceBillsId;
    }
    /**
     * 获取金额方向 
     * @return 金额方向
    ...
    /**
     * 设置金额方向
     * @param amountDirection 金额方向
     */
    public  void  setAmountDirection(String amountDirection){
