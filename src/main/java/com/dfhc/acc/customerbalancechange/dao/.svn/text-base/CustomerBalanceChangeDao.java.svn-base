 ...
 *
 * 文件名称：  CustomerBalanceChangeDao.java
 *
 * 功能描述：  客户余额变动数据访问对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.acc.customerbalancechange.dao;
 ...
 */
@Repository
public class CustomerBalanceChangeDao extends RmSqlSessionDaoSupport implements ICustomerBalanceChangeConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<CustomerBalanceChangeVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public void insertBatch(List<CustomerBalanceChangeVo> vos) {
        ...
        for(int i=0;i<vos.size();i++) {
           CustomerBalanceChangeVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
