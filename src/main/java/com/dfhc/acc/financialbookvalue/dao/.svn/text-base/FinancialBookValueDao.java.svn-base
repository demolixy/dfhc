 ...
 *
 * 文件名称：  FinancialBookValueDao.java
 *
 * 功能描述：  客户财务账面金额数据访问对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.acc.financialbookvalue.dao;
 ...
 */
@Repository
public class FinancialBookValueDao extends RmSqlSessionDaoSupport implements IFinancialBookValueConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<FinancialBookValueVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public void insertBatch(List<FinancialBookValueVo> vos) {
        ...
        for(int i=0;i<vos.size();i++) {
           FinancialBookValueVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
     ...
     * @return
     */
    public List<FinancialBookValueVo> listByUserIdForLock(Map<String, Object> searchPara, int startIndex, int size) {
        return getSqlSession().selectList(namespace("listByUserIdForLock"), searchPara, new RowBounds(startIndex-1, size));
    }
