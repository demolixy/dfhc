 ...
 *
 * 文件名称：  IFinancialBookValueConstants.java
 *
 * 功能描述：  客户财务账面金额常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.acc.financialbookvalue;
 ...
 * @see 参见的类
 */
public interface IFinancialBookValueConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "acc_financial_book_value";
    public final static String TABLE_NAME_DISPLAY = "客户财务账面金额";
