 ...
 *
 * 文件名称：  CustomerAvailableAmountVo.java
 *
 * 功能描述：  客户业务可用金额值对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.acc.customeravailableamount.vo;
 ...
 * @see 参见的类
 */
public class CustomerAvailableAmountVo extends RmValueObject{
    ...
    /**
     * availableCredit 表示：可用额度
     */
    private  java.math.BigDecimal  availableCredit;
    /**
     * freezingAmount 表示：冻结额度
     */
    private  java.math.BigDecimal  freezingAmount;
    /**
     * signature 表示：MD5签名
     */
     ...
     * @return 冻结额度
     */
    public  java.math.BigDecimal  getFreezingAmount(){
        return freezingAmount;
    }
    /**
     * 设置冻结额度
     * @param freezingAmount 冻结额度
     */
    public  void  setFreezingAmount(java.math.BigDecimal freezingAmount){
