 ...
 *
 * 文件名称：  ICustomerAvailableAmountConstants.java
 *
 * 功能描述：  客户业务可用金额常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.acc.customeravailableamount;
 ...
 * @see 参见的类
 */
public interface ICustomerAvailableAmountConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "acc_customer_available_amount";
    public final static String TABLE_NAME_DISPLAY = "客户业务可用金额";
    ...
    public final static Map<String, String> TABLE_COLUMN_DISPLAY = new CaseInsensitiveMap(){{
		...
		put("availableCredit","可用额度");
		put("freezingAmount","冻结额度");
		put("signature","MD5签名");
    }};
