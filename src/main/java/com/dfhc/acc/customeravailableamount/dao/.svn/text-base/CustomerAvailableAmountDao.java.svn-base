 ...
 *
 * 文件名称：  CustomerAvailableAmountDao.java
 *
 * 功能描述：  客户业务可用金额数据访问对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.acc.customeravailableamount.dao;
 ...
 */
@Repository
public class CustomerAvailableAmountDao extends RmSqlSessionDaoSupport implements ICustomerAvailableAmountConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<CustomerAvailableAmountVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public void insertBatch(List<CustomerAvailableAmountVo> vos) {
        ...
        for(int i=0;i<vos.size();i++) {
           CustomerAvailableAmountVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
     ...
     * @return
     */
    public List<CustomerAvailableAmountVo> getByUserForUpdate(Map<String, Object> searchPara,  int startIndex, int size) {
        
        return getSqlSession().selectList(namespace("getByUserForUpdate"), searchPara, new RowBounds(startIndex-1, size));
    }
