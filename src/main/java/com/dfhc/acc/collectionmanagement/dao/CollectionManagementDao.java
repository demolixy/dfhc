 ...
 *
 * 文件名称：  CollectionManagementDao.java
 *
 * 功能描述：  收款管理数据访问对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.acc.collectionmanagement.dao;
 ...
 */
@Repository
public class CollectionManagementDao extends RmSqlSessionDaoSupport implements ICollectionManagementConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<CollectionManagementVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public void insertBatch(List<CollectionManagementVo> vos) {
        ...
        for(int i=0;i<vos.size();i++) {
           CollectionManagementVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
