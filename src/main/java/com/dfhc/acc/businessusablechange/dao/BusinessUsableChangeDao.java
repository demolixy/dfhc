 ...
 *
 * 文件名称：  BusinessUsableChangeDao.java
 *
 * 功能描述：  业务可用额变动数据访问对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.acc.businessusablechange.dao;
 ...
 */
@Repository
public class BusinessUsableChangeDao extends RmSqlSessionDaoSupport implements IBusinessUsableChangeConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<BusinessUsableChangeVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public void insertBatch(List<BusinessUsableChangeVo> vos) {
        ...
        for(int i=0;i<vos.size();i++) {
           BusinessUsableChangeVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
