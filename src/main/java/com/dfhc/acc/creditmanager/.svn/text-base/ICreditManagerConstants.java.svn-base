 ...
 *
 * 文件名称：  ICreditManagerConstants.java
 *
 * 功能描述：  授信管理常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.acc.creditmanager;
 ...
 * @see 参见的类
 */
public interface ICreditManagerConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "acc_credit_manager";
    public final static String TABLE_NAME_DISPLAY = "授信管理";
