 ...
 */
package com.dfhc.acc.creditmanager.dao;
 ...
 */
@Repository
public class CreditManagerDao extends RmSqlSessionDaoSupport implements ICreditManagerConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<CreditManagerVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
