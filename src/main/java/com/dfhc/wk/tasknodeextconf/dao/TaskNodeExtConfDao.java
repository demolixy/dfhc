 ...
 */
package com.dfhc.wk.tasknodeextconf.dao;
 ...
 */
@Repository
public class TaskNodeExtConfDao extends RmSqlSessionDaoSupport implements ITaskNodeExtConfConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<TaskNodeExtConfVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public void insertBatch(List<TaskNodeExtConfVo> vos) {
        ...
        for(int i=0;i<vos.size();i++) {
           TaskNodeExtConfVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
