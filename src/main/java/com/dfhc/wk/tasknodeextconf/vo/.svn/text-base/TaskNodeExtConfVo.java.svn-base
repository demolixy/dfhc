 ...
 */
package com.dfhc.wk.tasknodeextconf.vo;
 ...
 * @see 参见的类
 */
public class TaskNodeExtConfVo extends RmValueObject{
    ...
    /**
     * taskDefinitionKey 表示：任务key
     */
    private  String  taskDefinitionKey;
    /**
     * readTaskDataScript 表示：读取任务数据脚本
     */
    private  String  readTaskDataScript;
    /**
     * readTaskDataScriptType 表示：读取任务数据脚本类型
     */
    private  String  readTaskDataScriptType;
    /**
     * writeTaskDataScript 表示：写入任务数据脚本
     */
    private  String  writeTaskDataScript;
    /**
     * writeTaskDataScriptType 表示：写入任务脚本类型
     */
    private  String  writeTaskDataScriptType;
    /**
     ...
     * @return 读取任务数据脚本
     */
    public  String  getReadTaskDataScript(){
        return readTaskDataScript;
    }
    /**
     * 设置读取任务数据脚本
     * @param readTaskDataScript 读取任务数据脚本
     */
    public  void  setReadTaskDataScript(String readTaskDataScript){
        this.readTaskDataScript = readTaskDataScript;
    }
    /**
     * 获取读取任务数据脚本类型 
     * @return 读取任务数据脚本类型
     */
    public  String  getReadTaskDataScriptType(){
        return readTaskDataScriptType;
    }
    /**
     * 设置读取任务数据脚本类型
     * @param readTaskDataScriptType 读取任务数据脚本类型
     */
    public  void  setReadTaskDataScriptType(String readTaskDataScriptType){
        this.readTaskDataScriptType = readTaskDataScriptType;
    }
    /**
     * 获取写入任务数据脚本 
     * @return 写入任务数据脚本
     */
    public  String  getWriteTaskDataScript(){
        return writeTaskDataScript;
    }
    /**
     * 设置写入任务数据脚本
     * @param writeTaskDataScript 写入任务数据脚本
     */
    public  void  setWriteTaskDataScript(String writeTaskDataScript){
        this.writeTaskDataScript = writeTaskDataScript;
    }
    /**
     * 获取写入任务脚本类型 
     * @return 写入任务脚本类型
     */
    public  String  getWriteTaskDataScriptType(){
        return writeTaskDataScriptType;
    }
    /**
     * 设置写入任务脚本类型
     * @param writeTaskDataScriptType 写入任务脚本类型
     */
    public  void  setWriteTaskDataScriptType(String writeTaskDataScriptType){
        this.writeTaskDataScriptType = writeTaskDataScriptType;
    }
