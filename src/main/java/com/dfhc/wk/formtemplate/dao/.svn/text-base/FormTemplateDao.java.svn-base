 ...
 */
package com.dfhc.wk.formtemplate.dao;
 ...
 */
@Repository
public class FormTemplateDao extends RmSqlSessionDaoSupport implements IFormTemplateConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<FormTemplateVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
