 ...
 */
package com.dfhc.wk.dataset.dao;
 ...
 */
@Repository
public class DataSetDao extends RmSqlSessionDaoSupport implements IDataSetConstants {
     ...
     */
    public String insert(DataSetVo vo) {
     ...
     */
    public String[] insert(DataSetVo[] vos) {
     ...
     * @return 成功更新的记录数
     */
    public int update(DataSetVo vo) {
     ...
     * @return 成功更新的记录数组
     */
    public int[] update(DataSetVo[] vos) {
     ...
     * @return 查询到的VO列表
     */
    public List<DataSetVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
     ...
     * @return
     */
    public List<DataSetVo> search(Map<String, Object> searchPara, String orderStr, int startIndex, int size) {
        searchPara.put("orderStr", orderStr);
     ...
     * @param vos vo列表
     */
    public void updateBatch(List<DataSetVo> vos) {
     ...
     * @param vos vo列表
     */
    public void insertBatch(List<DataSetVo> vos) {
        List<String> idList = null;
        //统计id为空的数量
        int requestIdNum = 0;
        for(int i=0;i<vos.size();i++) {
           DataSetVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
