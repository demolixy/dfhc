 ...
 */
package com.dfhc.wk.processdataitems.vo;
 ...
 * @see 参见的类
 */
public class ProcessDataItemsVo extends RmValueObject{
    ...
    /**
     * dataItemCnName 表示：数据项中文名
     */
    private  String  dataItemCnName;
    /**
     * dataItemEnName 表示：映射英文名
     */
    private  String  dataItemEnName;
    /**
     ...
     * @return 数据项中文名
     */
    public  String  getDataItemCnName(){
        return dataItemCnName;
    }
    /**
     * 设置数据项中文名
     * @param dataItemCnName 数据项中文名
     */
    public  void  setDataItemCnName(String dataItemCnName){
        this.dataItemCnName = dataItemCnName;
    }
    /**
     * 获取映射英文名 
     * @return 映射英文名
     */
    public  String  getDataItemEnName(){
        return dataItemEnName;
    }
    /**
     * 设置映射英文名
     * @param dataItemEnName 映射英文名
     */
    public  void  setDataItemEnName(String dataItemEnName){
        this.dataItemEnName = dataItemEnName;
    }
    /**
     * 获取业务组 
     * @return 业务组
