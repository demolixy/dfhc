 ...
 */
package com.dfhc.base.securityindex.dao;
 ...
 */
@Repository
public class SecurityIndexDao extends RmSqlSessionDaoSupport implements ISecurityIndexConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<SecurityIndexVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
