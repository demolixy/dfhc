 ...
 *
 * 文件名称：  ISecurityIndexConstants.java
 *
 * 功能描述：  安检指标表常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.base.securityindex;
 ...
 * @see 参见的类
 */
public interface ISecurityIndexConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "base_security_index";
    public final static String TABLE_NAME_DISPLAY = "安检指标表";
    ...
    public final static Map<String, String> TABLE_COLUMN_DISPLAY = new CaseInsensitiveMap(){{
		...
		put("checkType","检查类型");
		put("checkItem","检查项目");
		put("checkResultCtrlType","检查结果控件类型");
