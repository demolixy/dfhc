 ...
 */
package com.dfhc.base.receiptaddress.dao;
 ...
 */
@Repository
public class ReceiptAddressDao extends RmSqlSessionDaoSupport implements IReceiptAddressConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<ReceiptAddressVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public List<ReceiptAddressVo> getReceiptCustomer(Map<String, Object> searchPara, String orderStr, int startIndex, int size) {
        searchPara.put("orderStr", orderStr);
        return getSqlSession().selectList(namespace("getReceiptCustomer"), searchPara, new RowBounds(startIndex-1, size));
    }
}
