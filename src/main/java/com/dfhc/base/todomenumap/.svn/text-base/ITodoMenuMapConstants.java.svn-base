 ...
 *
 * 文件名称：  ITodoMenuMapConstants.java
 *
 * 功能描述：  待办菜单映射表常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.base.todomenumap;
 ...
 * @see 参见的类
 */
public interface ITodoMenuMapConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "base_todo_menu_map";
    public final static String TABLE_NAME_DISPLAY = "待办菜单映射表";
