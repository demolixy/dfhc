 ...
 */
package com.dfhc.base.todomenumap.dao;
 ...
 */
@Repository
public class TodoMenuMapDao extends RmSqlSessionDaoSupport implements ITodoMenuMapConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<TodoMenuMapVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
