 ...
 */
@Repository
public class CarDao extends RmSqlSessionDaoSupport implements ICarConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<CarVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
