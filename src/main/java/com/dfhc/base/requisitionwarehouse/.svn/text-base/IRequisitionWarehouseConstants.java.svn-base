 ...
 *
 * 文件名称：  IRequisitionWarehouseConstants.java
 *
 * 功能描述：  调拨库常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.base.requisitionwarehouse;
 ...
 * @see 参见的类
 */
public interface IRequisitionWarehouseConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "base_requisition_warehouse";
    public final static String TABLE_NAME_DISPLAY = "调拨库";
    ...
    public final static Map<String, String> TABLE_COLUMN_DISPLAY = new CaseInsensitiveMap(){{
		...
		put("city","市");
		put("cityId","市ID");
		put("districtCounty","区县");
		put("districtCountyId","区县ID");
		put("address","详细地址");
		put("flowToId","流向ID");
		put("contacts","联系人");
