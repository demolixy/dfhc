 ...
 *
 * 文件名称：  RequisitionWarehouseDao.java
 *
 * 功能描述：  调拨库数据访问对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.base.requisitionwarehouse.dao;
 ...
 */
@Repository
public class RequisitionWarehouseDao extends RmSqlSessionDaoSupport implements IRequisitionWarehouseConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<RequisitionWarehouseVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public void insertBatch(List<RequisitionWarehouseVo> vos) {
        ...
        for(int i=0;i<vos.size();i++) {
           RequisitionWarehouseVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
