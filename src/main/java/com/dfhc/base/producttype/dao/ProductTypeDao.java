 ...
 */
package com.dfhc.base.producttype.dao;
 ...
 */
@Repository
public class ProductTypeDao extends RmSqlSessionDaoSupport implements IProductTypeConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<ProductTypeVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
