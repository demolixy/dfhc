 ...
 *
 * 文件名称：  IProductTypeConstants.java
 *
 * 功能描述：  产品类别常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.base.producttype;
 ...
 * @see 参见的类
 */
public interface IProductTypeConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "base_product_type";
    public final static String TABLE_NAME_DISPLAY = "产品类别";
