 ...
 *
 * 文件名称：  ProductTypeController.java
 *
 * 功能描述：  产品类别Controller
 * 
 * 版本历史：
 ...
 */
package com.dfhc.base.producttype.web;
...
/**
 * list                  /producttype
 * insert page      GET  /producttype/insert
 * insert action    POST /producttype/insert
 * update page      GET  /producttype/update/{id}
 * update action    POST /producttype/update
 * delete action    POST /producttype/delete
 * detail                /producttype/detail/{id}

 * reference             /producttype/reference
 * import page      GET  /producttype/import
 * import action    POST /producttype/import
 * export custom    GET  /producttype/export
 * export action    POST /producttype/export
 */
...
public class ProductTypeController implements IProductTypeConstants {
    ...
    public String list(Model model, HttpServletRequest request) {
        ...
        return "/yulinchemical/base/producttype/listProductType";
    }
    ...
    @ResponseBody
    public Map<String,Object> insert(HttpServletRequest request, @Valid ProductTypeVo vo) {
        RmVoHelper.markCreateStamp(request,vo);  //打创建时间,IP戳
//        productTypeService.insert(vo);  //插入单条记录
        productTypeService.insert(vo,request); 
    ...
    @RequestMapping(value = "update", method = RequestMethod.POST, 
			consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public Map<String,Object> update(HttpServletRequest request, @Valid ProductTypeVo vo) {
        RmVoHelper.markModifyStamp(request,vo);  //打修改时间,IP戳
//        productTypeService.update(vo);  
        productTypeService.update(vo,request);//更新单条记录
        Map<String, Object> result = new HashMap<String, Object>();
        result.put(ISystemConstant.AJAX_STATUS, ISystemConstant.AJAX_RESULT_SUCCESS);
    ...
    public Map<String,Object> get(@PathVariable("id") String id, HttpServletRequest request) {
        ProductTypeVo bean = productTypeService.get(id);
        Map<String, Object> result = new HashMap<String, Object>();
        if(bean==null){
    ...
    public String delete(HttpServletRequest request, RedirectAttributes redirectAttributes) {
        ...
        if(id != null && id.length() > 0) {
            deleteCount = productTypeService.delete(new String(id));
        } else {
            String[] ids = RmJspHelper.getArrayFromRequest(request, REQUEST_IDS); //从request获取多条记录id
            if (ids != null && ids.length != 0) {
                deleteCount += productTypeService.delete(ids);  //删除多条记录
            }
        }
        redirectAttributes.addFlashAttribute("message", "删除成功: " + deleteCount);
        return "redirect:/producttype?"+ISystemConstant.RM_PARENT_CODE+"="+request.getParameter(ISystemConstant.RM_PARENT_CODE);
    }
   /**
    ...
    public String deleteLogic(HttpServletRequest request, RedirectAttributes redirectAttributes) {
        ...
        String id = request.getParameter(REQUEST_ID);
        if(id != null && id.length() > 0) {
            deleteCount = productTypeService.deleteLogic(request,new String(id));
        } else {
            String[] ids = RmJspHelper.getArrayFromRequest(request, REQUEST_IDS); //从request获取多条记录id
            if (ids != null && ids.length != 0) {
                deleteCount += productTypeService.deleteLogic(request,ids);  //删除多条记录
            }
        }
        redirectAttributes.addFlashAttribute("message", "删除成功: " + deleteCount);
        return "redirect:/producttype?"+ISystemConstant.RM_PARENT_CODE+"="+request.getParameter(ISystemConstant.RM_PARENT_CODE);
    ...
    public String detail(@PathVariable("id") String id, Model model, HttpServletRequest request) {
        ...
        return "/yulinchemical/base/producttype/detailProductType";
    }
    ...
    public String reference(Model model, HttpServletRequest request) {
        ...
        return "/yulinchemical/base/producttype/util/referenceProductType";
    }
    /**
     * 参照改为ajax
     * @param model
    ...
    public String importDataForm(Model model) {
        return "/yulinchemical/base/producttype/importProductType";
    }
    ...
    public String exportCustomForm(Model model) {
        return "/yulinchemical/base/producttype/exportProductType_custom";
    }
    ...
    public String exportData(Model model) {
        return "/yulinchemical/base/producttype/exportProductType_excel";
    }
    ...
    public static Map<String, Object> getQueryCondition(HttpServletRequest request) {
        ...
        if(request.getAttribute(REQUEST_QUERY_CONDITION) != null) {  //如果request.getAttribute中有，就不取request.getParameter
           ...
           searchMap.put("productTypeName", request.getParameter("productTypeName"));
           searchMap.put("isBuy", request.getParameter("isBuy"));
           searchMap.put("isSale", request.getParameter("isSale"));
