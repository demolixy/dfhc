 ...
 */
package com.dfhc.base.paymentmode.dao;
 ...
 */
@Repository
public class PaymentModeDao extends RmSqlSessionDaoSupport implements IPaymentModeConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<PaymentModeVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
