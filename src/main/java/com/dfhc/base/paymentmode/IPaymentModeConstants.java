 ...
 *
 * 文件名称：  IPaymentModeConstants.java
 *
 * 功能描述：  收款方式常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.base.paymentmode;
 ...
 * @see 参见的类
 */
public interface IPaymentModeConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "base_payment_mode";
    public final static String TABLE_NAME_DISPLAY = "收款方式";
