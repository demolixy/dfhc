 ...
 */
package com.dfhc.base.shipper.dao;
 ...
 */
@Repository
public class ShipperDao extends RmSqlSessionDaoSupport implements IShipperConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<ShipperVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
