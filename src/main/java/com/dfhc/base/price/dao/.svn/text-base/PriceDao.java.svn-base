 ...
 */
package com.dfhc.base.price.dao;
 ...
 */
@Repository
public class PriceDao extends RmSqlSessionDaoSupport implements IPriceConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<PriceVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public List<PriceVo> listSubProPrice(Map<String, Object> searchPara, String orderStr, int startIndex, int size) {
    	searchPara.put("orderStr", orderStr);
    	return getSqlSession().selectList(namespace("listSubProPrice"), searchPara, new RowBounds(startIndex-1, size));
    }
    /**
     * 查副产品价格趋势
     * @param searchPara
    ...
    public List<PriceVo> listPriceTrend(Map<String, Object> searchPara, String orderStr, int startIndex, int size) {
    	searchPara.put("orderStr", orderStr);
    	return getSqlSession().selectList(namespace("listPriceTrend"), searchPara, new RowBounds(startIndex-1, size));
    }
}
