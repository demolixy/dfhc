 ...
 * @see 参见的类
 */
public interface IPriceConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "base_price";
    public final static String TABLE_NAME_DISPLAY = "价格管理";
