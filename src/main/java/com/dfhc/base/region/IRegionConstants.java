...
public interface IRegionConstants extends IGlobalConstants {
    ...
    //表名、显示名
    public final static String TABLE_NAME = "base_region";
    public final static String TABLE_NAME_DISPLAY = "区域维护";
