 ...
 */
package com.dfhc.base.region.dao;
 ...
 */
@Repository
public class RegionDao extends RmSqlSessionDaoSupport implements IRegionConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<RegionVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
