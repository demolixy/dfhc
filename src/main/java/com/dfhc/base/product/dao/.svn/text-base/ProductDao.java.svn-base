 ...
 */
package com.dfhc.base.product.dao;
 ...
 */
@Repository
public class ProductDao extends RmSqlSessionDaoSupport implements IProductConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<ProductVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
