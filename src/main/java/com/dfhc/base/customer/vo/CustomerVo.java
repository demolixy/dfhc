 ...
 */
package com.dfhc.base.customer.vo;
 ...
 * @see 参见的类
 */
public class CustomerVo extends RmValueObject{
    ...
    /**
     * is_by_product 表示: 是否副产品客户
     */
    private  String isByProduct;
    /**
     * is_main_product 表示: 是否主产品客户
     */
   ...
   //开始vo的setter和getter方法     
	...
	/**
	 * 获取 是否主产品客户
	 * @return is_main_product 是否主产品客户
	 */
