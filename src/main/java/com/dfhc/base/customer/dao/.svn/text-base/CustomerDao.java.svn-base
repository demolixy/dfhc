 ...
 */
package com.dfhc.base.customer.dao;
 ...
 */
@Repository
public class CustomerDao extends RmSqlSessionDaoSupport implements ICustomerConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<CustomerVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
	...
	public CustomerVo getCustomerVo(String userId) {
		return getSqlSession().selectOne(namespace("getCustomerVoByUserId"), userId);
	}
