 ...
 */
package com.dfhc.base.warehousegate.dao;
 ...
 */
@Repository
public class WarehouseGateDao extends RmSqlSessionDaoSupport implements IWarehouseGateConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<WarehouseGateVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
