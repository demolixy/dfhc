 ...
 *
 * 文件名称：  IWarehouseGateConstants.java
 *
 * 功能描述：  仓库门号常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.base.warehousegate;
 ...
 * @see 参见的类
 */
public interface IWarehouseGateConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "base_warehouse_gate";
    public final static String TABLE_NAME_DISPLAY = "仓库门号";
