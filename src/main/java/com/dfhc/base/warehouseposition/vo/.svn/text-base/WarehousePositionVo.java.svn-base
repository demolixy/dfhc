 ...
 */
package com.dfhc.base.warehouseposition.vo;
 ...
 * @see 参见的类
 */
public class WarehousePositionVo extends RmValueObject{
    ...
    private  String  id;
    /**
     * warehouseGateId 表示：仓库门号ID
     */
    private  String  warehouseGateId;
    /**
     * name 表示：名称
     */
    private  String  name;
     ...
     * @return 仓库门号ID
     */
    public  String  getWarehouseGateId(){
        return warehouseGateId;
    }
    /**
     * 设置仓库门号ID
     * @param warehouseGateId 仓库门号ID
     */
    public  void  setWarehouseGateId(String warehouseGateId){
        this.warehouseGateId = warehouseGateId;
    }
    /**
     * 获取名称 
     * @return 名称
