 ...
 *
 * 文件名称：  WarehousePositionDao.java
 *
 * 功能描述：  仓位号数据访问对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.base.warehouseposition.dao;
 ...
 */
@Repository
public class WarehousePositionDao extends RmSqlSessionDaoSupport implements IWarehousePositionConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<WarehousePositionVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public void insertBatch(List<WarehousePositionVo> vos) {
        ...
        for(int i=0;i<vos.size();i++) {
           WarehousePositionVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
