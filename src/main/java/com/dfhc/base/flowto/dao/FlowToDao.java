 ...
 */
package com.dfhc.base.flowto.dao;
 ...
 */
@Repository
public class FlowToDao extends RmSqlSessionDaoSupport implements IFlowToConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<FlowToVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
