 ...
 * @see 参见的类
 */
public interface IFlowToConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "base_flow_to";
    public final static String TABLE_NAME_DISPLAY = "流向";
