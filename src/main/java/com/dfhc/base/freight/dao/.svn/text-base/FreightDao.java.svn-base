 ...
 */
package com.dfhc.base.freight.dao;
 ...
 */
@Repository
public class FreightDao extends RmSqlSessionDaoSupport implements IFreightConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<FreightVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
