 ...
 */
package com.dfhc.base.freight.vo;
 ...
 * @see 参见的类
 */
public class FreightVo extends RmValueObject{
    ...
    private  String  id;
    /**
     * shipperCode 表示：发货方编码
     */
    private  String  shipperCode;
    /**
     * targetId 表示：收货地址ID/站点ID/调拨库ID
     */
    ...
    /**
     * 设置收货地址ID/站点ID/调拨库ID
     * @param targetId 收货地址ID/站点ID/调拨库ID
     */
