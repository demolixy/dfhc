 ...
 */
package com.dfhc.base.trainstation.dao;
 ...
 */
@Repository
public class TrainStationDao extends RmSqlSessionDaoSupport implements ITrainStationConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<TrainStationVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public List<TrainStationVo> getI(Map<String, Object> searchPara, String orderStr, int startIndex, int size) {
        searchPara.put("orderStr", orderStr);
        return getSqlSession().selectList(namespace("getI"), searchPara, new RowBounds(startIndex-1, size));
    }
}
