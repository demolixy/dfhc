 ...
 *
 * 文件名称：  ITrainStationConstants.java
 *
 * 功能描述：  火车站点常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.base.trainstation;
 ...
 * @see 参见的类
 */
public interface ITrainStationConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "base_train_station";
    public final static String TABLE_NAME_DISPLAY = "火车站点";
