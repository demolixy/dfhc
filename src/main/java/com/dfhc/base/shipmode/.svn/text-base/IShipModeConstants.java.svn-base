 ...
 */
package com.dfhc.base.shipmode;
 ...
 * @see 参见的类
 */
public interface IShipModeConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "base_ship_mode";
    public final static String TABLE_NAME_DISPLAY = "发运方式";
