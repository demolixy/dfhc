 ...
 *
 * 文件名称：  ILogisticsCompanyConstants.java
 *
 * 功能描述：  物流公司常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.base.logisticscompany;
 ...
 * @see 参见的类
 */
public interface ILogisticsCompanyConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "base_logistics_company";
    public final static String TABLE_NAME_DISPLAY = "物流公司";
