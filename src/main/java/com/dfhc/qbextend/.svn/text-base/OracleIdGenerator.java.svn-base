...
import com.dfhc.pub.service.OracleSequenceService;
 ...
 * 日期:2015-01-21
 */
public class OracleIdGenerator implements IRmIdGenerator {
...
//        }else{
//        	for(int i=0;i<seqNum;i++){
//        		if(StringHelper.isEmpty(seqNums[i])){
//        			break;
//        		}
//        	}
//        }
	...
	public ISequenceService getSequenceService(){
		if(sequenceService==null){
			sequenceService=   (ISequenceService) RmBeanFactory.getBean(OracleSequenceService.class.getName());  //得到Service对象,受事务控制
		}
