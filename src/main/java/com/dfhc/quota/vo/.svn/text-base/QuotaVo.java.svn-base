 ...
 * @see 参见的类
 */
public class QuotaVo extends RmValueObject{
    ...
    /**
     * rechargeQuota 表示：充值额度
     */
    private  Integer  rechargeQuota;
    /**
     * freezeQuota 表示：冻结额度
     */
    private  Integer  freezeQuota;
    /**
     * availableQuota 表示：可用额度
     */
    private  Integer  availableQuota;
    /**
     * temporaryQuota 表示：临时额度
     */
    private  Integer  temporaryQuota;
    /**
     * quotaAmount 表示：额度对应金额
     */
    private  java.math.BigDecimal  quotaAmount;
    /**
     * signature 表示：MD5签名
     */
     ...
     * @return 充值额度
     */
    public  Integer  getRechargeQuota(){
        return rechargeQuota;
    }
    /**
     * 设置充值额度
     * @param rechargeQuota 充值额度
     */
    public  void  setRechargeQuota(Integer rechargeQuota){
     ...
     * @return 临时额度
     */
    public  Integer  getTemporaryQuota(){
        return temporaryQuota;
    }
    /**
     * 设置临时额度
     * @param temporaryQuota 临时额度
     */
    public  void  setTemporaryQuota(Integer temporaryQuota){
    ...
    /**
     * 设置额度对应金额
     * @param quotaAmount 额度对应金额
     */
    public  void  setQuotaAmount(java.math.BigDecimal quotaAmount){
