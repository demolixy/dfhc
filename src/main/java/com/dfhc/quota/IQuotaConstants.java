 ...
 * @see 参见的类
 */
public interface IQuotaConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "account_quota";
    public final static String TABLE_NAME_DISPLAY = "额度帐户";
    ...
    public final static Map<String, String> TABLE_COLUMN_DISPLAY = new CaseInsensitiveMap(){{
		...
		put("id","ID");
		put("userId","用户ID");
		put("accountHolderName","开户人名称");
		put("creditQuota","信用额度");
		put("rechargeQuota","充值额度");
		put("freezeQuota","冻结额度");
		put("availableQuota","可用额度");
		put("temporaryQuota","临时额度");
		put("quotaAmount","额度对应金额");
		put("signature","MD5签名");
    }};
