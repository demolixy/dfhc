 ...
 */
@Repository
public class QuotaDao extends RmSqlSessionDaoSupport implements IQuotaConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<QuotaVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
