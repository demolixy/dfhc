 ...
 *
 * 文件名称：  IProductInventoryConstants.java
 *
 * 功能描述：  产品库存中间表常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.bus.productinventory;
 ...
 * @see 参见的类
 */
public interface IProductInventoryConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "bus_product_inventory";
    public final static String TABLE_NAME_DISPLAY = "产品库存中间表";
    ...
    public final static Map<String, String> TABLE_COLUMN_DISPLAY = new CaseInsensitiveMap(){{
		...
		put("storageLocation","库位");
		put("storageNumber","库存数量");
		put("outboundNumber","出库数量");
    }};
