 ...
 */
@Repository
public class GateDao extends RmSqlSessionDaoSupport implements IGateConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<GateVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
