 ...
 * @see 参见的类
 */
public interface IGateConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "bus_gate";
    public final static String TABLE_NAME_DISPLAY = "门岗";
