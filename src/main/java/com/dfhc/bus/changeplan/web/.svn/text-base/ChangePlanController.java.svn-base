 ...
 *
 * 文件名称：  ChangePlanController.java
 *
 * 功能描述：  变车管理Controller
 * 
 * 版本历史：
 ...
 */
package com.dfhc.bus.changeplan.web;
...
/**
 * list                  /changeplan
 * insert page      GET  /changeplan/insert
 * insert action    POST /changeplan/insert
 * update page      GET  /changeplan/update/{id}
 * update action    POST /changeplan/update
 * delete action    POST /changeplan/delete
 * detail                /changeplan/detail/{id}

 * reference             /changeplan/reference
 * import page      GET  /changeplan/import
 * import action    POST /changeplan/import
 * export custom    GET  /changeplan/export
 * export action    POST /changeplan/export
 */
...
public class ChangePlanController implements IChangePlanConstants {
    ...
    public String list(Model model, HttpServletRequest request) {
        ...
        return "/yulinchemical/bus/changeplan/listChangePlan";
    }
    ...
    @ResponseBody
    public Map<String,Object> insert(HttpServletRequest request, @Valid ChangePlanVo vo) {
        RmVoHelper.markCreateStamp(request,vo);  //打创建时间,IP戳
        changePlanService.insert(vo);  //插入单条记录
    ...
    @RequestMapping(value = "update", method = RequestMethod.POST, 
			consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public Map<String,Object> update(HttpServletRequest request, @Valid ChangePlanVo vo) {
        RmVoHelper.markModifyStamp(request,vo);  //打修改时间,IP戳
        changePlanService.update(vo);  //更新单条记录
        Map<String, Object> result = new HashMap<String, Object>();
        result.put(ISystemConstant.AJAX_STATUS, ISystemConstant.AJAX_RESULT_SUCCESS);
    ...
    public Map<String,Object> get(@PathVariable("id") String id, HttpServletRequest request) {
        ChangePlanVo bean = changePlanService.get(id);
        Map<String, Object> result = new HashMap<String, Object>();
        if(bean==null){
    ...
    public String delete(HttpServletRequest request, RedirectAttributes redirectAttributes) {
        ...
        if(id != null && id.length() > 0) {
            deleteCount = changePlanService.delete(new String(id));
        } else {
            String[] ids = RmJspHelper.getArrayFromRequest(request, REQUEST_IDS); //从request获取多条记录id
            if (ids != null && ids.length != 0) {
                deleteCount += changePlanService.delete(ids);  //删除多条记录
            }
        }
        redirectAttributes.addFlashAttribute("message", "删除成功: " + deleteCount);
        return "redirect:/changeplan?"+ISystemConstant.RM_PARENT_CODE+"="+request.getParameter(ISystemConstant.RM_PARENT_CODE);
    }
   /**
    ...
    public String deleteLogic(HttpServletRequest request, RedirectAttributes redirectAttributes) {
        ...
        String id = request.getParameter(REQUEST_ID);
        if(id != null && id.length() > 0) {
            deleteCount = changePlanService.deleteLogic(request,new String(id));
        } else {
            String[] ids = RmJspHelper.getArrayFromRequest(request, REQUEST_IDS); //从request获取多条记录id
            if (ids != null && ids.length != 0) {
                deleteCount += changePlanService.deleteLogic(request,ids);  //删除多条记录
            }
        }
        redirectAttributes.addFlashAttribute("message", "删除成功: " + deleteCount);
        return "redirect:/changeplan?"+ISystemConstant.RM_PARENT_CODE+"="+request.getParameter(ISystemConstant.RM_PARENT_CODE);
    ...
    public String detail(@PathVariable("id") String id, Model model, HttpServletRequest request) {
        ...
        return "/yulinchemical/bus/changeplan/detailChangePlan";
    }
    ...
    public String reference(Model model, HttpServletRequest request) {
        ...
        return "/yulinchemical/bus/changeplan/util/referenceChangePlan";
    }
    /**
     * 参照改为ajax
     * @param model
    ...
    public String importDataForm(Model model) {
        return "/yulinchemical/bus/changeplan/importChangePlan";
    }
    ...
    public String exportCustomForm(Model model) {
        return "/yulinchemical/bus/changeplan/exportChangePlan_custom";
    }
    ...
    public String exportData(Model model) {
        return "/yulinchemical/bus/changeplan/exportChangePlan_excel";
    }
