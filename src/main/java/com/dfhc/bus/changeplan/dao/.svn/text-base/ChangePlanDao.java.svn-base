 ...
 */
package com.dfhc.bus.changeplan.dao;
 ...
 */
@Repository
public class ChangePlanDao extends RmSqlSessionDaoSupport implements IChangePlanConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<ChangePlanVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
