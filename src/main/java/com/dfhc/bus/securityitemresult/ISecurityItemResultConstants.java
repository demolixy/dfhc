 ...
 *
 * 文件名称：  ISecurityItemResultConstants.java
 *
 * 功能描述：  车辆安全检查项目结果常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.bus.securityitemresult;
 ...
 * @see 参见的类
 */
public interface ISecurityItemResultConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "bus_security_item_result";
    public final static String TABLE_NAME_DISPLAY = "车辆安全检查项目结果";
    ...
    public final static Map<String, String> TABLE_COLUMN_DISPLAY = new CaseInsensitiveMap(){{
		...
		put("id","ID");
		put("vehicleSafetyInspectionId","车辆安全检查ID");
		put("checkType","检查类型");
		put("checkItem","检查项目");
		put("checkResult","检查结果值");
		put("checkResultCtrlName","检查结果控件名称");
    }};
