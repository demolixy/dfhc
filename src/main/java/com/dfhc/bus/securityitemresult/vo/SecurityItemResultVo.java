 ...
 *
 * 文件名称：  SecurityItemResultVo.java
 *
 * 功能描述：  车辆安全检查项目结果值对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.bus.securityitemresult.vo;
 ...
 * @see 参见的类
 */
public class SecurityItemResultVo extends RmValueObject{
    ...
    private  String  id;
    /**
     * vehicleSafetyInspectionId 表示：车辆安全检查ID
     */
    private  String  vehicleSafetyInspectionId;
    /**
     * checkType 表示：检查类型
     */
     ...
     * @return 车辆安全检查ID
     */
    public  String  getVehicleSafetyInspectionId(){
        return vehicleSafetyInspectionId;
    }
    /**
     * 设置车辆安全检查ID
     * @param vehicleSafetyInspectionId 车辆安全检查ID
     */
    public  void  setVehicleSafetyInspectionId(String vehicleSafetyInspectionId){
        this.vehicleSafetyInspectionId = vehicleSafetyInspectionId;
    }
    /**
     * 获取检查类型 
     * @return 检查类型
