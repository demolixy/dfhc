 ...
 */
@Repository
public class MsgDao extends RmSqlSessionDaoSupport implements IMsgConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<MsgVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
