 ...
 *
 * 文件名称：  IRecipientsConstants.java
 *
 * 功能描述：  消息收件人常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.bus.recipients;
 ...
 * @see 参见的类
 */
public interface IRecipientsConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "bus_recipients";
    public final static String TABLE_NAME_DISPLAY = "消息收件人";
    ...
    public final static Map<String, String> TABLE_COLUMN_DISPLAY = new CaseInsensitiveMap(){{
		...
		put("id","ID");
		put("messageId","消息ID");
		put("recipientId","接收人ID");
		put("recipient","接收人");
		put("readTime","阅读时间");
		put("messageStatus","消息状态");
    }};
