 ...
 */
package com.dfhc.bus.recipients.dao;
 ...
 */
@Repository
public class RecipientsDao extends RmSqlSessionDaoSupport implements IRecipientsConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<RecipientsVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
