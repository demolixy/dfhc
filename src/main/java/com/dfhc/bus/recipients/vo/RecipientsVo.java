 ...
 */
package com.dfhc.bus.recipients.vo;
 ...
 * @see 参见的类
 */
public class RecipientsVo extends RmValueObject{
     ...
     * readTime 表示：阅读时间
     */
    private  java.sql.Date  readTime;
    /**
     * messageStatus 表示：消息状态
     */
