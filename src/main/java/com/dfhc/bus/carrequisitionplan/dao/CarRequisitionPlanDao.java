 ...
 *
 * 文件名称：  CarRequisitionPlanDao.java
 *
 * 功能描述：  汽运调拨计划数据访问对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.bus.carrequisitionplan.dao;
 ...
 */
@Repository
public class CarRequisitionPlanDao extends RmSqlSessionDaoSupport implements ICarRequisitionPlanConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<CarRequisitionPlanVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public void insertBatch(List<CarRequisitionPlanVo> vos) {
        ...
        for(int i=0;i<vos.size();i++) {
           CarRequisitionPlanVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
