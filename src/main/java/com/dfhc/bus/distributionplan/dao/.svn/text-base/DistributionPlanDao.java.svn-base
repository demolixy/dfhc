 ...
 */
package com.dfhc.bus.distributionplan.dao;
 ...
 */
@Repository
public class DistributionPlanDao extends RmSqlSessionDaoSupport implements IDistributionPlanConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<DistributionPlanVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public void insertBatch(List<DistributionPlanVo> vos) {
        ...
        for(int i=0;i<vos.size();i++) {
           DistributionPlanVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
