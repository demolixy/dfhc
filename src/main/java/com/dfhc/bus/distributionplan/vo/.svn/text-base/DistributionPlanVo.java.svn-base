 ...
 */
package com.dfhc.bus.distributionplan.vo;
 ...
 * @see 参见的类
 */
public class DistributionPlanVo extends RmValueObject{
    ...
    /**
     * planDistributionDate 表示：计划配送日期
     */
    private  java.sql.Date  planDistributionDate;
    /**
     ...
     * @return 计划配送日期
     */
    public  java.sql.Date  getPlanDistributionDate(){
        return planDistributionDate;
    }
    /**
     * 设置计划配送日期
     * @param planDistributionDate 计划配送日期
     */
    public  void  setPlanDistributionDate(java.sql.Date planDistributionDate){
        this.planDistributionDate = planDistributionDate;
    }
    /**
     * 获取派车计划图片 
     * @return 派车计划图片
