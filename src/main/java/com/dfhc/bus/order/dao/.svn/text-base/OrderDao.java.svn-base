 ...
 */
package com.dfhc.bus.order.dao;
 ...
 */
@Repository
public class OrderDao extends RmSqlSessionDaoSupport implements IOrderConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<OrderVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
