 ...
 *
 * 文件名称：  IProductBatchNumberConstants.java
 *
 * 功能描述：  产品批次记录常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.bus.productbatchnumber;
 ...
 * @see 参见的类
 */
public interface IProductBatchNumberConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "bus_product_batch_number";
    public final static String TABLE_NAME_DISPLAY = "产品批次记录";
