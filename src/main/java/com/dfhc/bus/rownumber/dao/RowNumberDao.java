 ...
 */
package com.dfhc.bus.rownumber.dao;
 ...
 */
@Repository
public class RowNumberDao extends RmSqlSessionDaoSupport implements IRowNumberConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<RowNumberVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
     ...
     * @return
     */
    public List<RowNumberVo> listProduct(Map<String, Object> params){
    	return getSqlSession().selectList(namespace("groupBySearch"), params);
    }
    
    public List<String> getProductIds(Map<String, Object> params){
    	return getSqlSession().selectList(namespace("groupByProductId"), params);
    }
    
    public List<CarListInteVo> getCarList(Map<String, Object> variable){
    	return getSqlSession().selectList(namespace("carList"), variable);
    }
    ...
    public List<RowNumberVo> getInFacCarNum(Map<String, Object> params){
    	return getSqlSession().selectList(namespace("getInFacCarNum"), params);
    }
}
