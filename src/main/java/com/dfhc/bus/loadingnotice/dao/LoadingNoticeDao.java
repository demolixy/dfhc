 ...
 */
package com.dfhc.bus.loadingnotice.dao;
 ...
 */
@Repository
public class LoadingNoticeDao extends RmSqlSessionDaoSupport implements ILoadingNoticeConstants {
     ...
     * 
     * @param id 用于查找的id
     * @return 查询到的多个打印的VO对象
     */
    public List<LoadingNoticeVo> getPrint(String id) {
        return getSqlSession().selectList(namespace("getPrint"), id);
    }
    /**
     * 查询并锁定
     * @param id
     * @return
     */
    public LoadingNoticeVo getForLock(String id) {
    	return getSqlSession().selectOne(namespace("getForLock"), id);
    }
     ...
     * @return 查询到的VO列表
     */
    public List<LoadingNoticeVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
