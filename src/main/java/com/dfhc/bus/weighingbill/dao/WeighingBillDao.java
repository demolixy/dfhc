 ...
 */
package com.dfhc.bus.weighingbill.dao;
 ...
 */
@Repository
public class WeighingBillDao extends RmSqlSessionDaoSupport implements IWeighingBillConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<WeighingBillVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
