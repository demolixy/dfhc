 ...
 *
 * 文件名称：  IOrderProductDetailConstants.java
 *
 * 功能描述：  销售订单产品明细常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.bus.orderproductdetail;
 ...
 * @see 参见的类
 */
public interface IOrderProductDetailConstants extends IGlobalConstants {

    //表名、显示名
    public final static String REMAINDER_CARNUM_ISNOTZERRO = "remainderCarNumIsNotZero";
    public final static String TABLE_NAME = "bus_order_product_detail";
    public final static String TABLE_NAME_DISPLAY = "销售订单产品明细";
    ...
    public final static Map<String, String> TABLE_COLUMN_DISPLAY = new CaseInsensitiveMap(){{
		...
		put("plannedVolume","计划发运量");
		put("unitPrice","单价");
		put("carNum","车数量");
		put("remarkVolume","剩余发运量");
