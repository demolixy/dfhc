 ...
 *
 * 文件名称：  VehicleSafetyInspectionDao.java
 *
 * 功能描述：  车辆安全检查数据访问对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.bus.vehiclesafetyinspection.dao;
 ...
 */
@Repository
public class VehicleSafetyInspectionDao extends RmSqlSessionDaoSupport implements IVehicleSafetyInspectionConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<VehicleSafetyInspectionVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public void insertBatch(List<VehicleSafetyInspectionVo> vos) {
        ...
        for(int i=0;i<vos.size();i++) {
           VehicleSafetyInspectionVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
