 ...
 *
 * 文件名称：  PurchaseIntentionDao.java
 *
 * 功能描述：  购买意向管理数据访问对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.bus.purchaseintention.dao;
 ...
 */
@Repository
public class PurchaseIntentionDao extends RmSqlSessionDaoSupport implements IPurchaseIntentionConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<PurchaseIntentionVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public void insertBatch(List<PurchaseIntentionVo> vos) {
        ...
        for(int i=0;i<vos.size();i++) {
           PurchaseIntentionVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
