 ...
 *
 * 文件名称：  ITrainsRequisitionPlanConstants.java
 *
 * 功能描述：  铁运调拨计划常量
 * 
 * 版本历史：
 ...
 */
package com.dfhc.bus.trainsrequisitionplan;
 ...
 * @see 参见的类
 */
public interface ITrainsRequisitionPlanConstants extends IGlobalConstants {

    //表名、显示名
    public final static String TABLE_NAME = "bus_trains_requisition_plan";
    //铁运调拨计划单号
    public final static String TRAINS_PLAN_CODE = "TRAINS_PLAN_CODE";
    public final static String TABLE_NAME_DISPLAY = "铁运调拨计划";
    ...
    public final static Map<String, String> TABLE_COLUMN_DISPLAY = new CaseInsensitiveMap(){{
		...
		put("flowToId","流向ID");
		put("status","状态");
		put("receivingParty","收货方");
		put("sendCarDate","发车日期");
		put("arriveAtStation","站点");
		put("shipMode","发运方式");
   }};
