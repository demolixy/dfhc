 ...
 *
 * 文件名称：  TrainsRequisitionPlanDao.java
 *
 * 功能描述：  铁运调拨计划数据访问对象
 * 
 * 版本历史：
 ...
 */
package com.dfhc.bus.trainsrequisitionplan.dao;
 ...
 */
@Repository
public class TrainsRequisitionPlanDao extends RmSqlSessionDaoSupport implements ITrainsRequisitionPlanConstants {
     ...
     * @return 查询到的VO列表
     */
    public List<TrainsRequisitionPlanVo> list(Map<String, Object> searchPara, String orderStr, int startIndex, int size, boolean allClumn) {
    ...
    public void insertBatch(List<TrainsRequisitionPlanVo> vos) {
        ...
        for(int i=0;i<vos.size();i++) {
           TrainsRequisitionPlanVo vo = vos.get(i);
           if(vo.getId() == null || vo.getId().length() == 0) {
