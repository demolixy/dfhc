...
public interface IRmUserConstants extends IGlobalConstants {
    ...
    //Sql语句
    public final static String SQL_INSERT = "insert into RM_USER ( ID, NAME, LOCK_STATUS, LOGIN_ID, PASSWORD, AUTHEN_TYPE, ORGANIZATION_ID, EMPLOYEE_ID, EMAIL, ADMIN_TYPE, DESCRIPTION, AGENT_STATUS, LOGIN_STATUS, LAST_LOGIN_DATE, LAST_LOGIN_IP, LOGIN_SUM, LAST_CUSTOM_CSS, IS_AFFIX, FUNCTION_PERMISSION, DATA_PERMISSION, CUSTOM1, CUSTOM2, CUSTOM3, CUSTOM4, CUSTOM5, CUSTOM_XML,CREATE_TIME,CREATE_USER_NAME, USABLE_STATUS, MODIFY_DATE, MODIFY_IP, MODIFY_USER_ID,ATTRIBUTE1,USER_TYPE,ATTRIBUTE2) values ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ,?, ?, ?, ? ,?,?,?)";
    ...
    public final static String SQL_FIND_BY_ID = "select RM_USER.ID, RM_USER.NAME, RM_USER.LOCK_STATUS, RM_USER.LOGIN_ID, RM_USER.PASSWORD, RM_USER.AUTHEN_TYPE, RM_USER.ORGANIZATION_ID, RM_USER.EMPLOYEE_ID, RM_USER.EMAIL, RM_USER.ADMIN_TYPE, RM_USER.DESCRIPTION, RM_USER.AGENT_STATUS, RM_USER.LOGIN_STATUS, RM_USER.LAST_LOGIN_DATE, RM_USER.LAST_LOGIN_IP, RM_USER.LOGIN_SUM, RM_USER.LAST_CUSTOM_CSS, RM_USER.IS_AFFIX, RM_USER.FUNCTION_PERMISSION, RM_USER.DATA_PERMISSION, RM_USER.CUSTOM1, RM_USER.CUSTOM2, RM_USER.CUSTOM3, RM_USER.CUSTOM4, RM_USER.CUSTOM5, RM_USER.CUSTOM_XML, RM_USER.USABLE_STATUS, RM_USER.MODIFY_DATE, RM_USER.MODIFY_IP, RM_USER.MODIFY_USER_ID ,RM_USER.ATTRIBUTE1,RM_USER.USER_TYPE,RM_USER.ATTRIBUTE2 from RM_USER where RM_USER.ID=?";

    public final static String SQL_UPDATE_BY_ID = "update RM_USER set NAME=?, LOCK_STATUS=?, LOGIN_ID=?, PASSWORD=?, AUTHEN_TYPE=?, ORGANIZATION_ID=?, EMPLOYEE_ID=?, EMAIL=?, ADMIN_TYPE=?, DESCRIPTION=?, AGENT_STATUS=?, LOGIN_STATUS=?, LAST_LOGIN_DATE=?, LAST_LOGIN_IP=?, LOGIN_SUM=?, LAST_CUSTOM_CSS=?, IS_AFFIX=?, FUNCTION_PERMISSION=?, DATA_PERMISSION=?, CUSTOM1=?, CUSTOM2=?, CUSTOM3=?, CUSTOM4=?, CUSTOM5=?, CUSTOM_XML=?, USABLE_STATUS=?, MODIFY_DATE=?, MODIFY_IP=?, MODIFY_USER_ID=? , ATTRIBUTE1=?,USER_TYPE=?,ATTRIBUTE2=? where ID=?";
    ...
    public final static String SQL_QUERY_ALL = "select RM_USER.ID, RM_USER.NAME, RM_USER.LOCK_STATUS, RM_USER.LOGIN_ID, RM_USER.AUTHEN_TYPE, RM_USER.ORGANIZATION_ID, RM_USER.EMPLOYEE_ID, RM_USER.EMAIL, RM_USER.ADMIN_TYPE, RM_USER.AGENT_STATUS, RM_USER.LOGIN_STATUS, RM_USER.LAST_LOGIN_DATE, RM_USER.LAST_LOGIN_IP, RM_USER.LOGIN_SUM, RM_USER.IS_AFFIX , RM_USER.USER_TYPE,RM_USER.ATTRIBUTE1,RM_USER.ATTRIBUTE2" +
    ...
    public final static String SQL_QUERY_ALL_EXPORT = "select RM_USER.ID, RM_USER.NAME, RM_USER.LOCK_STATUS, RM_USER.LOGIN_ID, RM_USER.PASSWORD, RM_USER.AUTHEN_TYPE, RM_USER.ORGANIZATION_ID, RM_USER.EMPLOYEE_ID, RM_USER.EMAIL, RM_USER.ADMIN_TYPE, RM_USER.DESCRIPTION, RM_USER.AGENT_STATUS, RM_USER.LOGIN_STATUS, RM_USER.LAST_LOGIN_DATE, RM_USER.LAST_LOGIN_IP, RM_USER.LOGIN_SUM, RM_USER.LAST_CUSTOM_CSS, RM_USER.IS_AFFIX, RM_USER.FUNCTION_PERMISSION, RM_USER.DATA_PERMISSION, RM_USER.CUSTOM1, RM_USER.CUSTOM2, RM_USER.CUSTOM3, RM_USER.CUSTOM4, RM_USER.CUSTOM5, RM_USER.CUSTOM_XML, RM_USER.USABLE_STATUS, RM_USER.MODIFY_DATE, RM_USER.MODIFY_IP, RM_USER.MODIFY_USER_ID,RM_USER.ATTRIBUTE2,RM_USER.USER_TYPE from RM_USER";
     ...
     * partytype业务类型
     */
    public final static String SUBMIT_BK="submit_bk";
}