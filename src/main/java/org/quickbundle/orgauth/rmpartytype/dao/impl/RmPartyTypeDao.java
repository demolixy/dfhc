...
public class RmPartyTypeDao extends RmJdbcTemplate implements IRmPartyTypeDao, IRmPartyTypeConstants {
    ...
    public String insert(RmPartyTypeVo vo) {
        ...
        vo.setId(id);
        Object[] obj = { vo.getId(), vo.getBs_keyword(),vo.getName(),vo.getIcon(),vo.getDescription(),vo.getIs_custom_attribute(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(),vo.getIs_allow_hanging_user(),vo.getIs_allow_hanging_role() };
	...
	public String[] insert(final RmPartyTypeVo[] vos) {
		...
		batchUpdate(SQL_INSERT, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				...
				return new Object[]{ vo.getId(), vo.getBs_keyword(),vo.getName(),vo.getIcon(),vo.getDescription(),vo.getIs_custom_attribute(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(),vo.getIs_allow_hanging_role(),vo.getIs_allow_hanging_user() };
			}
		});
		return ids;
	}
    ...
    public int update(RmPartyTypeVo vo) {
        Object[] obj = { vo.getBs_keyword(),vo.getName(),vo.getIcon(),vo.getDescription(),vo.getIs_custom_attribute(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(),vo.getIs_allow_hanging_role(),vo.getIs_allow_hanging_user() , vo.getId()};
	...
	public int[] update(final RmPartyTypeVo[] vos) {
		return batchUpdate(SQL_UPDATE_BY_ID, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmPartyTypeVo vo = (RmPartyTypeVo)obj;
				return new Object[]{ vo.getBs_keyword(),vo.getName(),vo.getIcon(),vo.getDescription(),vo.getIs_custom_attribute(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(),vo.getIs_allow_hanging_role(),vo.getIs_allow_hanging_user(), vo.getId() };
			}
		});
	}
