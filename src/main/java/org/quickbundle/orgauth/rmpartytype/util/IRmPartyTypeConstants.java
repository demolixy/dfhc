...
public interface IRmPartyTypeConstants extends IGlobalConstants {
    ...
    //Sql语句
    public final static String SQL_INSERT = "insert into RM_PARTY_TYPE ( ID, BS_KEYWORD, NAME, ICON, DESCRIPTION, IS_CUSTOM_ATTRIBUTE, USABLE_STATUS, MODIFY_DATE, MODIFY_IP, MODIFY_USER_ID,IS_ALLOW_HANGING_USER,IS_ALLOW_HANGING_ROLE) values ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,? )";
    ...
    public final static Map<String, String> TABLE_COLUMN_CHINESE = new CaseInsensitiveMap(){{
		...
		put("is_allow_hanging_user","是否允许挂接用户");
		put("is_allow_hanging_role","是否允许挂接角色");
    }};
