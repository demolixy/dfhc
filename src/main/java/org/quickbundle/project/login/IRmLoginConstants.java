...
public interface IRmLoginConstants extends IGlobalConstants {
	...
	public enum LoginForward {
		...
		//手持设备强制登录跳转
		LOGIN_FORCE_HANDHELD_FORWARD("loginForceHandheldForward"),
		//手持登录页面
		LOGIN_FORCE_HANDHELD("loginForceHandheld"),
		
		//安检登录成功跳转页面
		TO_LOGIN_SECURITY("toLoginSecurity"),
		//叉车班长登录成功跳转页面
		TO_LOGIN_FORKLIFT("toLoginForklift"),
		//保运主管登录成功跳转页面
		TO_LOGIN_SUPERVISOR("toLoginSupervisor"),
